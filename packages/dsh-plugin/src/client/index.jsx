...
const dictionaries = {
  zh: {
    ...
    refresh: '刷新', jobs: '评测批次', jobsHint: '点击 Job 后，最多再点一次即可进入对应 Trial 的证据。', workspace: '工作空间', workspaceSelect: '选择 Harbor 工作空间', empty: '还没有评测结果。请评测最近会话，或通过 Harbor Agent 创建评测。',
  ...
  en: {
    ...
    refresh: 'Refresh', jobs: 'Evaluation jobs', jobsHint: 'Open a Job, then reach Trial evidence in at most one more interaction.', workspace: 'Workspace', workspaceSelect: 'Select Harbor workspace', empty: 'No evaluation results yet. Evaluate recent sessions or create an evaluation through the Harbor Agent.',
