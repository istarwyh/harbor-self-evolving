...
function normalizeHarborUiError(value, observedAt = (/* @__PURE__ */ new Date()).toISOString()) {
  ...
  const category = /PERMISSION|UNAUTHORIZED|FORBIDDEN|SESSION_PROJECT|PROJECT_MISMATCH/i.test(code) ? "permission" : /NOT_FOUND|MISSING|UNKNOWN_OBJECT|NO_SUCH/i.test(code) ? "missing" : /ARTIFACT|CONTEXT_INVALID|PROVENANCE|INVALID_JSON|SCHEMA/i.test(code) ? "artifact" : "retry";
...
var HarborUiBridge = class {
  ...
  async issue(sessionId, value, options = {}) {
    ...
    if (!pending) {
      ...
      pending = request.then((value2) => Object.freeze({ ...value2, context, fingerprint, oneShot: true })).finally(() => this.inflight.delete(key));
...
function identity(value, idKey = "id", digestKey = "digest") {
  ...
  return Object.values(result).some((item) => item !== void 0) ? result : void 0;
}
...
function buildUiContext({ sessionId, pageSessionId, workspace, job, stage = "candidate", trial, criterion, evidenceRef, detail, jobSummary, comparison, gate, filters, sort }) {
  ...
  const selected = evidenceRef ? { kind: "evidence", id: evidenceRef, job, stage, trial, ...criterion ? { criterion } : {}, evidenceRef } : criterion ? { kind: "criterion", id: criterion, job, stage, trial, criterion } : void 0;
...
function TrialDetail({ state, t, focused, onFocus, onAsk, retry }) {
  ...
  (0, import_react.useEffect)(() => {
    const key = focused?.evidenceRef ? evidenceFocusKey(focused.criterion, focused.evidenceRef) : focused?.criterion ? `criterion:${focused.criterion}` : void 0;
  ...
  return /* @__PURE__ */ import_react.default.createElement("article", { className: "hse-trial-detail", "aria-live": "polite" }, /* @__PURE__ */ import_react.default.createElement("div", { className: "hse-trial-score" }, /* @__PURE__ */ import_react.default.createElement("div", null, /* @__PURE__ */ import_react.default.createElement("span", null, t("score")), /* @__PURE__ */ import_react.default.createElement("b", null, score.valid ? format(score.value) : "\u2014")), /* @__PURE__ */ import_react.default.createElement("span", { className: unscored ? "hse-muted" : score.valid ? "hse-valid" : "hse-invalid" }, unscored ? "completed-unscored" : score.valid ? `\u2713 ${t("valid")}` : `\xD7 ${t("invalid")}`)), !score.valid ? /* @__PURE__ */ import_react.default.createElement("div", { className: "hse-detail-group" }, /* @__PURE__ */ import_react.default.createElement("h4", null, t("validity")), /* @__PURE__ */ import_react.default.createElement("ul", null, (score.invalid_reasons ?? []).map((reason) => /* @__PURE__ */ import_react.default.createElement("li", { key: reason }, reason)))) : null, /* @__PURE__ */ import_react.default.createElement("div", { className: "hse-detail-group" }, /* @__PURE__ */ import_react.default.createElement("h4", null, t("findings")), /* @__PURE__ */ import_react.default.createElement("ul", null, (assessment.findings ?? []).length ? assessment.findings.map((item, index) => /* @__PURE__ */ import_react.default.createElement("li", { key: index }, item.code ? `${item.code}: ` : "", item.message ?? String(item))) : /* @__PURE__ */ import_react.default.createElement("li", null, "\u2014"))), /* @__PURE__ */ import_react.default.createElement("div", { className: "hse-detail-group" }, /* @__PURE__ */ import_react.default.createElement("h4", null, t("recommendations")), /* @__PURE__ */ import_react.default.createElement("ul", null, (assessment.recommendations ?? []).length ? assessment.recommendations.map((item, index) => /* @__PURE__ */ import_react.default.createElement("li", { key: index }, item.message ?? String(item))) : /* @__PURE__ */ import_react.default.createElement("li", null, "\u2014"))), /* @__PURE__ */ import_react.default.createElement("div", { className: "hse-detail-group" }, /* @__PURE__ */ import_react.default.createElement("h4", null, t("output")), /* @__PURE__ */ import_react.default.createElement("pre", null, pretty(assessment.output))), /* @__PURE__ */ import_react.default.createElement("div", { className: "hse-detail-group" }, /* @__PURE__ */ import_react.default.createElement("h4", null, t("criteria")), /* @__PURE__ */ import_react.default.createElement("div", { className: "hse-criteria" }, criteria.map((item) => /* @__PURE__ */ import_react.default.createElement("div", { ref: (node) => ownFocusNode(`criterion:${item.id}`, node), className: "hse-criterion", "data-highlight": String(focused?.criterion === item.id), key: item.id, role: "button", tabIndex: 0, onClick: () => onFocus({ criterion: item.id }), onKeyDown: (event) => {
  ...
  }))), /* @__PURE__ */ import_react.default.createElement("div", { className: "hse-detail-group" }, /* @__PURE__ */ import_react.default.createElement("h4", null, t("timing")), /* @__PURE__ */ import_react.default.createElement("pre", null, pretty(assessment.process))), /* @__PURE__ */ import_react.default.createElement("details", { className: "hse-detail-group" }, /* @__PURE__ */ import_react.default.createElement("summary", null, t("audit")), /* @__PURE__ */ import_react.default.createElement("pre", null, pretty(assessment))));
}
function TrialExplorer({ job, workspace, active, navigation, restoreView, onViewStateChange, onRestoreReady, onRestoreCancel, contextFor, setContext, resetContext, askContext, t }) {
  ...
  (0, import_react.useEffect)(() => {
    ...
    if (!target?.trial) {
      ...
      resetContext?.();
      queueMicrotask(() => {
        if (handledNavigation.current === navigation) handledNavigation.current = void 0;
      });
      return;
    }
  ...
  (0, import_react.useEffect)(() => {
    ...
    const load = async () => {
      try {
        ...
        setSelected((current) => value.items?.some((item) => String(item.id ?? item.datasetTrial) === String(current)) ? current : value.items?.[0]?.id ?? value.items?.[0]?.datasetTrial);
      } catch (error) {
        if (!cancelled) setListState((current) => trialListFailureState(current, listRequestKey, error));
      }
    };
...
function Workbench({ job, workspace, jobs, close, navigation, restoreView, hasHistory, scrollContainerRef, onViewStateChange, sessionId, pageSessionId, bridge, askContext, t }) {
  ...
  if (stage === "candidate") content = historical ? /* @__PURE__ */ import_react.default.createElement(HistoricalTargetPanel, { detail, artifacts, t }) : /* @__PURE__ */ import_react.default.createElement(CandidatePanel, { artifacts, t });
    ...
    onViewStateChange?.({ stage, trialView: value, ...compareBaselineState.current ? { compareBaseline: compareBaselineState.current } : {} });
    ...
    onViewStateChange?.({ stage, compareBaseline: value, ...gateRouteState.current ? { gateRoute: gateRouteState.current } : {}, ...trialViewState.current ? { trialView: trialViewState.current } : {} });
  }, contextFor, setContext: publishContext, askContext, t }), /* @__PURE__ */ import_react.default.createElement(GateEvidencePanel, { artifacts, t }));
...
function DashboardSessionView({ t, bridge, stop, sessionId, useSession, useInput, inputActions, replaceHarborReference }) {
  ...
  (0, import_react.useEffect)(() => {
    ...
    if (!navigation?.actionId) return void 0;
  ...
  return /* @__PURE__ */ import_react.default.createElement(HarborSessionContext.Provider, { value: sessionId }, /* @__PURE__ */ import_react.default.createElement("main", { ref: rootNode, className: "hse-root" }, /* @__PURE__ */ import_react.default.createElement("div", { className: "hse-page" }, /* @__PURE__ */ import_react.default.createElement(CopilotDock, { bridge, sessionId, useSession, stop, resolveLatest, reanalyzeLatest, t }), selected ? /* @__PURE__ */ import_react.default.createElement(Workbench, { key: `${selected.workspace}\0${selected.job}`, job: selected.job, workspace: selected.workspace, jobs: snapshot?.jobs ?? [], close: closeWorkbench, navigation: selected.navigation, restoreView: selected.restoreView, hasHistory: selected.fromNavigation, scrollContainerRef: rootNode, onViewStateChange: (value) => {
    activeWorkbenchView.current = value;
  }, sessionId, pageSessionId, bridge, askContext, t }) : /* @__PURE__ */ import_react.default.createElement(import_react.default.Fragment, null, historyDepth ? /* @__PURE__ */ import_react.default.createElement("button", { type: "button", className: "hse-button hse-dashboard-back", onClick: closeWorkbench }, t("back")) : null, /* @__PURE__ */ import_react.default.createElement("section", { className: "hse-hero", style: { "--ocean-image": `url(${harbor_ocean_default})` } }, /* @__PURE__ */ import_react.default.createElement("button", { className: "hse-refresh", onClick: () => void state.load() }, t("refresh")), /* @__PURE__ */ import_react.default.createElement("div", { className: "hse-eyebrow" }, /* @__PURE__ */ import_react.default.createElement("span", { className: "hse-whale", "aria-hidden": "true" }, "\u{1F433}"), t("eyebrow")), /* @__PURE__ */ import_react.default.createElement("h1", null, t("heroTitle")), /* @__PURE__ */ import_react.default.createElement("p", null, t("heroBody")), /* @__PURE__ */ import_react.default.createElement("div", { className: "hse-stats" }, stats.map(([label, value]) => /* @__PURE__ */ import_react.default.createElement("div", { className: "hse-stat", key: label }, /* @__PURE__ */ import_react.default.createElement("span", null, label), /* @__PURE__ */ import_react.default.createElement("b", null, value))))), snapshot?.workspace ? /* @__PURE__ */ import_react.default.createElement(HistoricalLauncher, { snapshot, reload: state.load, onCompleted: completedHistorical, t }) : null, state.stale ? /* @__PURE__ */ import_react.default.createElement("div", { className: "hse-capability" }, t("dashboardStale")) : null, /* @__PURE__ */ import_react.default.createElement("div", { className: "hse-head" }, /* @__PURE__ */ import_react.default.createElement("div", null, /* @__PURE__ */ import_react.default.createElement("h2", null, t("jobs")), /* @__PURE__ */ import_react.default.createElement("p", null, t("jobsHint"))), snapshot?.workspaces?.length ? /* @__PURE__ */ import_react.default.createElement("select", { className: "hse-select", "aria-label": t("workspaceSelect"), value: snapshot.workspace?.id ?? "", onChange: switchWorkspace }, snapshot.workspaces.map((item) => /* @__PURE__ */ import_react.default.createElement("option", { value: item.id, key: item.id }, item.label, " \xB7 ", item.root))) : null), snapshot?.workspace ? /* @__PURE__ */ import_react.default.createElement("div", { className: "hse-hook-state" }, /* @__PURE__ */ import_react.default.createElement("b", null, t("workspace"), ": ", snapshot.workspace.label), /* @__PURE__ */ import_react.default.createElement("br", null), snapshot.config.projectRoot, " \xB7 ", snapshot.config.jobsDir) : null, state.status === "loading" ? /* @__PURE__ */ import_react.default.createElement(HarborSkeleton, { kind: "dashboard", rows: 7, label: t("loading") }) : state.status === "error" && !snapshot ? /* @__PURE__ */ import_react.default.createElement(HarborErrorState, { error: state.errorDetails ?? state.error, retry: () => void state.load(), t }) : !snapshot?.jobs?.length ? /* @__PURE__ */ import_react.default.createElement("div", { className: "hse-empty" }, t("empty")) : /* @__PURE__ */ import_react.default.createElement(import_react.default.Fragment, null, /* @__PURE__ */ import_react.default.createElement("div", { className: "hse-list" }, snapshot.jobs.map((job) => /* @__PURE__ */ import_react.default.createElement(JobCard, { job, t, open: openJob, ask: askJob, key: job.name }))), /* @__PURE__ */ import_react.default.createElement("div", { className: "hse-pager" }, /* @__PURE__ */ import_react.default.createElement("span", null, pagination.total ? `${offset + 1}\u2013${Math.min(offset + (snapshot.jobs?.length ?? 0), pagination.total)} / ${pagination.total}` : "0 / 0"), /* @__PURE__ */ import_react.default.createElement("button", { disabled: !offset, onClick: () => setOffset(Math.max(0, offset - (pagination.limit ?? 20))) }, t("previous")), /* @__PURE__ */ import_react.default.createElement("button", { disabled: !pagination.hasMore, onClick: () => setOffset(offset + (pagination.limit ?? 20)) }, t("next"))))))));
}
