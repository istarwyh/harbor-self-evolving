...
function pollActionOperation({ draft, request, initialOperation, getCurrent, onOperation, onError, onAbsent, intervalMs = 1500, schedule = setTimeout, unschedule = clearTimeout }) {
  ...
  const poll = async () => {
    ...
    try {
      ...
      onOperation(current);
      if (actionOperationActive(current)) timer = schedule(poll, Math.min(2e3, Math.max(100, intervalMs)));
    } catch (error) {
      if (!alive) return;
...
function ActionDraftCardView({ draft, onSourceDraft, onReprepare, onViewComparison, onViewResult, request, update, ErrorState, t }) {
  ...
  (0, import_react.useEffect)(() => {
    ...
    if (state.operation && !actionOperationActive(state.operation)) return void 0;
...
function SavedEvaluatorNextSteps({ receipt, historicalJob, onPreparePlan, t }) {
  ...
  const [state, setState] = (0, import_react3.useState)({ key, status: "idle", showVersion: false });
  const current = state.key === key ? state : { key, status: "idle", showVersion: false };
  const activeKey = (0, import_react3.useRef)(key);
  activeKey.current = key;
  const preparing = (0, import_react3.useRef)(/* @__PURE__ */ new Set());
  const prepare = async () => {
  ...
  return /* @__PURE__ */ import_react3.default.createElement("section", { className: "hse-section hse-save-receipt", "data-saved-evaluator-version": receipt?.evaluator?.version }, /* @__PURE__ */ import_react3.default.createElement("h3", null, t("savedVersionTitle")), /* @__PURE__ */ import_react3.default.createElement("p", null, "Evaluator ", receipt?.evaluator?.version ?? "\u2014", " \xB7 Stack ", receipt?.stack?.version ?? "\u2014"), /* @__PURE__ */ import_react3.default.createElement("b", null, t("savedVersionNext")), /* @__PURE__ */ import_react3.default.createElement("p", null, t("savedVersionExplanation")), /* @__PURE__ */ import_react3.default.createElement("p", { className: "hse-muted" }, t("savedVersionHistory")), /* @__PURE__ */ import_react3.default.createElement("div", { className: "hse-editor-actions" }, /* @__PURE__ */ import_react3.default.createElement("button", { type: "button", className: "hse-button", disabled: !prompt || typeof onPreparePlan !== "function" || current.status === "preparing", onClick: () => void prepare() }, t(current.status === "preparing" ? "savedVersionPreparing" : "savedVersionPlan")), /* @__PURE__ */ import_react3.default.createElement("button", { type: "button", className: "hse-button", "aria-expanded": current.showVersion, onClick: () => setState({ ...current, showVersion: !current.showVersion }) }, t(current.showVersion ? "savedVersionHide" : "savedVersionView"))), !prompt ? /* @__PURE__ */ import_react3.default.createElement("p", { role: "alert" }, t("savedVersionPlanUnavailable")) : typeof onPreparePlan !== "function" ? /* @__PURE__ */ import_react3.default.createElement("p", { role: "status" }, t("savedVersionComposerUnavailable")) : null, current.status === "prepared" ? /* @__PURE__ */ import_react3.default.createElement("p", { role: "status" }, t("savedVersionPrepared")) : current.status === "error" ? /* @__PURE__ */ import_react3.default.createElement("p", { role: "alert" }, t("savedVersionPrepareFailed")) : null, current.showVersion ? /* @__PURE__ */ import_react3.default.createElement("section", { className: "hse-saved-version", "aria-label": t("savedVersionView") }, /* @__PURE__ */ import_react3.default.createElement("p", { className: "hse-capability" }, t("savedVersionSnapshot")), /* @__PURE__ */ import_react3.default.createElement("div", { className: "hse-grid" }, /* @__PURE__ */ import_react3.default.createElement("div", { className: "hse-card" }, /* @__PURE__ */ import_react3.default.createElement("span", null, "Evaluator"), /* @__PURE__ */ import_react3.default.createElement("b", null, receipt?.evaluator?.evaluator_id, " \xB7 ", receipt?.evaluator?.version), /* @__PURE__ */ import_react3.default.createElement("code", null, receipt?.evaluator?.descriptor_path), /* @__PURE__ */ import_react3.default.createElement("code", null, receipt?.evaluator?.digest)), /* @__PURE__ */ import_react3.default.createElement("div", { className: "hse-card" }, /* @__PURE__ */ import_react3.default.createElement("span", null, "Stack"), /* @__PURE__ */ import_react3.default.createElement("b", null, receipt?.stack?.id, " \xB7 ", receipt?.stack?.version), /* @__PURE__ */ import_react3.default.createElement("code", null, receipt?.stack?.path))), /* @__PURE__ */ import_react3.default.createElement("h4", null, t("savedVersionFiles")), files.length ? files.map((file) => /* @__PURE__ */ import_react3.default.createElement("details", { className: "hse-source-details", key: file.path }, /* @__PURE__ */ import_react3.default.createElement("summary", null, file.path), /* @__PURE__ */ import_react3.default.createElement("p", { className: "hse-muted" }, file.digest), /* @__PURE__ */ import_react3.default.createElement("pre", { className: "hse-source", "aria-label": file.path }, file.text))) : /* @__PURE__ */ import_react3.default.createElement("p", null, t("savedVersionSourceMissing"))) : null);
}
...
var HarborSessionContext = (0, import_react4.createContext)(void 0);
function useHarborApi() {
  const sessionId = (0, import_react4.useContext)(HarborSessionContext);
  if (!sessionId) throw new Error("Harbor workspace requests require a DSH Session");
  return (0, import_react4.useCallback)((route, params = {}, options) => api(route, { ...params, sessionId }, options), [sessionId]);
}
function useHarborMutation() {
  const sessionId = (0, import_react4.useContext)(HarborSessionContext);
  if (!sessionId) throw new Error("Harbor workspace mutations require a DSH Session");
  return (0, import_react4.useCallback)((route, value = {}) => mutate(route, { ...value, sessionId }), [sessionId]);
}
function HarborSkeleton({ kind = "default", rows = 5, label = "Loading" }) {
  return /* @__PURE__ */ import_react4.default.createElement("div", { className: "hse-skeleton", "data-kind": kind, role: "status", "aria-label": label, "aria-busy": "true" }, Array.from({ length: rows }, (_, index) => /* @__PURE__ */ import_react4.default.createElement("i", { "aria-hidden": "true", key: index })));
}
...
function HarborErrorState({ error, title, retry, retryLabel, t }) {
  ...
  return /* @__PURE__ */ import_react4.default.createElement("div", { className: "hse-error-state", "data-category": value.category, role: "alert" }, /* @__PURE__ */ import_react4.default.createElement("div", null, /* @__PURE__ */ import_react4.default.createElement("b", null, title ?? value.message), title && title !== value.message ? /* @__PURE__ */ import_react4.default.createElement("span", null, value.message) : null, /* @__PURE__ */ import_react4.default.createElement("small", null, t("errorCode"), ": ", /* @__PURE__ */ import_react4.default.createElement("code", null, value.code), " \xB7 ", t("errorAt"), ": ", /* @__PURE__ */ import_react4.default.createElement("time", { dateTime: value.observedAt }, new Date(value.observedAt).toLocaleString())), /* @__PURE__ */ import_react4.default.createElement("small", null, t("nextStep"), ": ", errorNextStep(value, t))), retry ? /* @__PURE__ */ import_react4.default.createElement("button", { type: "button", onClick: retry }, retryLabel ?? t("retry")) : null);
}
...
function useHarborUi(bridge, sessionId) {
  return (0, import_react4.useSyncExternalStore)(
    (0, import_react4.useCallback)((listener) => bridge.subscribe(sessionId, listener), [bridge, sessionId]),
    (0, import_react4.useCallback)(() => bridge.getSnapshot(sessionId), [bridge, sessionId]),
    () => EMPTY_UI_STATE
  );
}
...
function useDashboard(poll = true, workspace = "", offset = 0, sessionId, attention = "all") {
  ...
  const requestSequence = (0, import_react4.useRef)(0);
  const pollDelay = (0, import_react4.useRef)(15e3);
  const load = (0, import_react4.useCallback)(async (quiet = false) => {
...
function useVersionCheck() {
  const [state, setState] = (0, import_react4.useState)({ status: "loading" });
  const load = (0, import_react4.useCallback)(async (refresh = false) => {
...
function ContextFlags({ context, t }) {
  ...
  return values.length ? /* @__PURE__ */ import_react4.default.createElement("span", { className: "hse-context-flags" }, values.map((value) => /* @__PURE__ */ import_react4.default.createElement("em", { key: value }, value))) : null;
}
...
function ContextDock({ bridge, sessionId, useInput, useSession, stop, inputActions, replaceHarborReference, clearHarborReferences, t }) {
  ...
  const dockNode = (0, import_react4.useRef)();
  const draft = useInput((state) => state?.draft ?? "");
  const phase = useInput((state) => state?.phase ?? "plain");
  const phaseRef = (0, import_react4.useRef)(phase);
  phaseRef.current = phase;
  const occurrences = useInput((state) => state?.occurrences ?? []);
  const submitted = (0, import_react4.useRef)();
  const observedTokens = (0, import_react4.useRef)(/* @__PURE__ */ new Set());
  const [clock, setClock] = (0, import_react4.useState)(Date.now);
  ...
  return /* @__PURE__ */ import_react4.default.createElement(HarborSessionContext.Provider, { value: sessionId }, /* @__PURE__ */ import_react4.default.createElement("div", { className: "hse-input-dock", ref: dockNode }, ui.workbenchDock?.narrow ? /* @__PURE__ */ import_react4.default.createElement("aside", { className: "hse-mobile-copilot" }, /* @__PURE__ */ import_react4.default.createElement(CopilotDock, { bridge, sessionId, useSession, stop, resolveLatest: ui.workbenchDock.resolveLatest, reanalyzeLatest: ui.workbenchDock.reanalyzeLatest, prepareQuestion: ui.workbenchDock.prepareQuestion, t })) : null, /* @__PURE__ */ import_react4.default.createElement("section", { className: "hse-context-dock", "aria-live": "polite" }, /* @__PURE__ */ import_react4.default.createElement("div", { className: "hse-context-line" }, /* @__PURE__ */ import_react4.default.createElement("strong", null, t("currentPage")), ui.current ? /* @__PURE__ */ import_react4.default.createElement(import_react4.default.Fragment, null, /* @__PURE__ */ import_react4.default.createElement("span", { className: "hse-context-chip" }, /* @__PURE__ */ import_react4.default.createElement("span", null, contextLabel(ui.current))), /* @__PURE__ */ import_react4.default.createElement(ContextFlags, { context: ui.current, t }), /* @__PURE__ */ import_react4.default.createElement("button", { type: "button", className: "hse-context-link", disabled: ui.status === "binding", onClick: () => void update(ui.current) }, explicit ? t("updateContext") : t("askAboutThis"))) : /* @__PURE__ */ import_react4.default.createElement("span", { className: "hse-muted" }, "Harbor \u2014")), /* @__PURE__ */ import_react4.default.createElement("div", { className: "hse-context-line" }, /* @__PURE__ */ import_react4.default.createElement("strong", null, t("turnContext")), explicit ? /* @__PURE__ */ import_react4.default.createElement(import_react4.default.Fragment, null, /* @__PURE__ */ import_react4.default.createElement("span", { className: "hse-context-chip" }, /* @__PURE__ */ import_react4.default.createElement("span", null, explicit.context.route?.params?.stage ?? "Harbor"), /* @__PURE__ */ import_react4.default.createElement("button", { type: "button", "aria-label": t("clearContext"), disabled: isHarborInputBusy(phase), onClick: clear }, t("clearContext"), " \xD7")), /* @__PURE__ */ import_react4.default.createElement(ContextFlags, { context: explicit.context, t }), expired ? /* @__PURE__ */ import_react4.default.createElement(import_react4.default.Fragment, null, /* @__PURE__ */ import_react4.default.createElement("em", { className: "hse-context-error" }, t("contextExpired")), /* @__PURE__ */ import_react4.default.createElement("small", null, t("contextExpiredHint")), /* @__PURE__ */ import_react4.default.createElement("button", { type: "button", className: "hse-context-link", disabled: !ui.current || ui.status === "binding", onClick: () => void update(ui.current) }, t("updateContext"))) : /* @__PURE__ */ import_react4.default.createElement("small", null, t("oneShot"))) : /* @__PURE__ */ import_react4.default.createElement("span", { className: "hse-muted" }, ui.status === "binding" ? t("bindingContext") : t("noTurnContext"))), explicit ? /* @__PURE__ */ import_react4.default.createElement("div", { className: "hse-capsule-parts" }, capsuleParts.map((part) => /* @__PURE__ */ import_react4.default.createElement("span", { className: "hse-context-chip", key: part.key }, /* @__PURE__ */ import_react4.default.createElement("span", null, part.label), /* @__PURE__ */ import_react4.default.createElement("button", { type: "button", "aria-label": `${t("clearContext")} ${part.label}`, disabled: isHarborInputBusy(phase) || ui.status === "binding", onClick: () => void removePart(part.key) }, "\xD7"))), /* @__PURE__ */ import_react4.default.createElement("details", { className: "hse-context-identity" }, /* @__PURE__ */ import_react4.default.createElement("summary", null, t("contextIdentity")), /* @__PURE__ */ import_react4.default.createElement("pre", null, pretty2({ ...capsuleContext, contextSnapshotId: explicit.contextSnapshotId, expiresAt: explicit.expiresAt })))) : null, ui.error ? /* @__PURE__ */ import_react4.default.createElement(HarborErrorState, { error: ui.error, title: t("contextBindFailed"), t }) : null, ui.current ? /* @__PURE__ */ import_react4.default.createElement("div", { className: "hse-context-questions", "aria-label": t("questionSuggestions") }, harborQuestionKeys(explicit?.context ?? ui.current).map((key) => /* @__PURE__ */ import_react4.default.createElement("button", { type: "button", key, disabled: expired || isHarborInputBusy(phase) || ui.status === "binding", onClick: () => void ask(t(key)) }, t(harborQuestionLabelKey(key)))), ui.lastSent?.context && !explicit ? /* @__PURE__ */ import_react4.default.createElement("button", { type: "button", disabled: isHarborInputBusy(phase) || ui.status === "binding", title: t("followupHint"), onClick: () => void ask("", ui.lastSent.context) }, t("continueObject")) : null) : null)));
}
function AnswerText({ text }) {
  const lines = String(text ?? "").split("\n");
  let code = false;
  const inline = (line) => line.split(/(`[^`]+`)/g).map((part, i) => part.startsWith("`") && part.endsWith("`") ? /* @__PURE__ */ import_react4.default.createElement("code", { key: i }, part.slice(1, -1)) : part);
  return /* @__PURE__ */ import_react4.default.createElement("div", { className: "hse-answer-text" }, lines.map((line, index) => {
    if (line.startsWith("```")) {
      code = !code;
      return /* @__PURE__ */ import_react4.default.createElement("hr", { key: index });
    }
    if (code) return /* @__PURE__ */ import_react4.default.createElement("pre", { key: index }, line || " ");
    if (/^#{1,4} /.test(line)) return /* @__PURE__ */ import_react4.default.createElement("h4", { key: index }, inline(line.replace(/^#{1,4} /, "")));
    if (/^[-*] /.test(line)) return /* @__PURE__ */ import_react4.default.createElement("p", { className: "hse-answer-bullet", key: index }, "\u2022 ", inline(line.slice(2)));
    return line.trim() ? /* @__PURE__ */ import_react4.default.createElement("p", { key: index }, inline(line)) : null;
  }));
}
function ActionDraftCard({ draft, onSourceDraft, onReprepare, onViewComparison, onViewResult, t }) {
  ...
  return /* @__PURE__ */ import_react4.default.createElement(ActionDraftCardView, { ...{ draft, onSourceDraft, onReprepare, onViewComparison, onViewResult, update, request, t }, ErrorState: HarborErrorState });
}
...
function CopilotDock({ bridge, sessionId, useSession, stop, resolveLatest, reanalyzeLatest, prepareQuestion, t }) {
  const [expanded, setExpanded] = (0, import_react4.useState)(() => !bridge.getSnapshot(sessionId).workbenchDock?.narrow);
  const [selectedSeq, setSelectedSeq] = (0, import_react4.useState)();
  const [latest, setLatest] = (0, import_react4.useState)({ status: "idle" });
  const latestSequence = (0, import_react4.useRef)(0);
  const ui = useHarborUi(bridge, sessionId);
...
${draft.proposal?.summary ?? ""}`);
  ...
  const refreshLatest = (0, import_react4.useCallback)(async () => {
  ...
  return /* @__PURE__ */ import_react4.default.createElement("section", { className: "hse-copilot", style: !ui.workbenchDock?.narrow && ui.composerTop ? { maxHeight: Math.max(80, ui.composerTop - 120), boxSizing: "border-box" } : void 0, "data-collapsed": String(!expanded), "aria-live": "polite" }, /* @__PURE__ */ import_react4.default.createElement("div", { className: "hse-copilot-head" }, /* @__PURE__ */ import_react4.default.createElement("h3", null, "\u{1F433} ", t("copilot")), /* @__PURE__ */ import_react4.default.createElement("div", { className: "hse-copilot-controls" }, activeRunning && stop ? /* @__PURE__ */ import_react4.default.createElement("button", { type: "button", onClick: () => void stop() }, t("stopAgent")) : null, /* @__PURE__ */ import_react4.default.createElement("button", { type: "button", className: "hse-copilot-toggle", "aria-expanded": expanded, "aria-label": expanded ? t("collapse") : t("expand"), onClick: () => setExpanded((value) => !value) }, expanded ? "\u2212" : "+"))), !expanded ? /* @__PURE__ */ import_react4.default.createElement("p", { className: "hse-copilot-status" }, activeRunning ? status : answer ? t("replyReady") : t("copilotIdle")) : null, expanded ? /* @__PURE__ */ import_react4.default.createElement(import_react4.default.Fragment, null, /* @__PURE__ */ import_react4.default.createElement("p", { className: "hse-copilot-status" }, status), projection.turns?.length > 1 ? /* @__PURE__ */ import_react4.default.createElement("details", { className: "hse-discussion-history" }, /* @__PURE__ */ import_react4.default.createElement("summary", null, t("discussionHistory"), " \xB7 ", projection.turns.length), projection.turns.map((item) => /* @__PURE__ */ import_react4.default.createElement("button", { type: "button", key: item.seq, "aria-current": item.seq === projection.selectedSeq ? "true" : void 0, onClick: () => setSelectedSeq(item.seq) }, item.question || t("aiQuestion"))), /* @__PURE__ */ import_react4.default.createElement("button", { type: "button", onClick: () => setSelectedSeq(void 0) }, t("latestReply"))) : null, projection.question ? /* @__PURE__ */ import_react4.default.createElement("div", { className: "hse-question" }, /* @__PURE__ */ import_react4.default.createElement("strong", null, t("aiQuestion")), /* @__PURE__ */ import_react4.default.createElement("p", null, projection.question)) : null, projection.continuation ? /* @__PURE__ */ import_react4.default.createElement("p", { className: "hse-copilot-status" }, t("followupUnbound")) : null, token ? /* @__PURE__ */ import_react4.default.createElement("div", { className: "hse-hook-state" }, /* @__PURE__ */ import_react4.default.createElement("b", null, t("copilotTurn"), ": ", turnId ?? "\u2014"), /* @__PURE__ */ import_react4.default.createElement("br", null), contextSummary ? contextLabel(contextSummary) : basis?.job ? `Job ${basis.job}` : t("historyOnly"), stale ? /* @__PURE__ */ import_react4.default.createElement("p", null, t("contextStale")) : null) : null, answer ? /* @__PURE__ */ import_react4.default.createElement("div", { className: "hse-copilot-answer" }, /* @__PURE__ */ import_react4.default.createElement(AnswerText, { text: answer })) : null, answer && !activeRunning && !references.some((ref) => ref.kind === "evidence" && ref.available) ? /* @__PURE__ */ import_react4.default.createElement("div", { className: "hse-answer-unverified", role: "status" }, /* @__PURE__ */ import_react4.default.createElement("p", null, t("evidenceNotChecked"))) : null, references.length ? /* @__PURE__ */ import_react4.default.createElement("div", { className: "hse-copilot-refs" }, /* @__PURE__ */ import_react4.default.createElement("strong", null, references.some((reference) => reference.kind === "evidence") ? t("evidenceRefs") : t("objectRefs")), references.map((reference) => /* @__PURE__ */ import_react4.default.createElement("button", { type: "button", className: "hse-copilot-ref", "data-available": String(reference.available), key: reference.action.actionId, onClick: () => bridge.navigate(sessionId, reference.action, { force: true }) }, /* @__PURE__ */ import_react4.default.createElement("b", null, reference.label ?? t("viewInHarbor")), /* @__PURE__ */ import_react4.default.createElement("span", null, reference.kind === "evidence" ? t("evidence") : t("objectRefs")), /* @__PURE__ */ import_react4.default.createElement("code", null, harborReferenceIdentity(reference), reference.available ? "" : ` \xB7 ${t("evidenceUnavailable")}`)))) : null, actionDrafts.map((draft) => /* @__PURE__ */ import_react4.default.createElement(ActionDraftCard, { key: draft.draftId, draft, onSourceDraft: openSourceDraft, onReprepare: reprepare, onViewComparison: viewComparison, onViewResult: (result) => viewDiagnostic(draft, result), t })), discussionContext && prepareQuestion ? /* @__PURE__ */ import_react4.default.createElement("div", { className: "hse-copilot-actions" }, /* @__PURE__ */ import_react4.default.createElement("button", { type: "button", disabled: activeRunning || ui.status === "binding", onClick: () => void prepareQuestion(discussionContext, "") }, t("continueObject")), /* @__PURE__ */ import_react4.default.createElement("small", null, t("followupHint"))) : null, basis || activeCalls.length || settledTools.length ? /* @__PURE__ */ import_react4.default.createElement("details", { className: "hse-answer-details" }, /* @__PURE__ */ import_react4.default.createElement("summary", null, t("answerDetails")), /* @__PURE__ */ import_react4.default.createElement("p", null, t("contextFreshness"), ": ", freshness ?? "\u2014"), activeCalls.length || settledTools.length ? /* @__PURE__ */ import_react4.default.createElement("div", { className: "hse-copilot-tools" }, [...activeCalls.map((call) => call.name ?? call.toolName ?? call.callId), ...settledTools].filter(Boolean).map((name2, index) => /* @__PURE__ */ import_react4.default.createElement("span", { key: `${name2}-${index}` }, name2))) : null, basis ? /* @__PURE__ */ import_react4.default.createElement("div", { className: "hse-copilot-basis" }, /* @__PURE__ */ import_react4.default.createElement("strong", null, t("basedOn")), basis.job ? /* @__PURE__ */ import_react4.default.createElement("span", null, "Job", /* @__PURE__ */ import_react4.default.createElement("b", null, basis.job)) : null, basis.artifactRevision ? /* @__PURE__ */ import_react4.default.createElement("span", null, t("revision"), /* @__PURE__ */ import_react4.default.createElement("code", null, short(basis.artifactRevision))) : null, basis.currentRevision && basis.currentRevision !== basis.artifactRevision ? /* @__PURE__ */ import_react4.default.createElement("span", null, t("currentRevision"), /* @__PURE__ */ import_react4.default.createElement("code", null, short(basis.currentRevision))) : null, basis.observedAt ? /* @__PURE__ */ import_react4.default.createElement("span", null, t("observedAt"), /* @__PURE__ */ import_react4.default.createElement("time", { dateTime: basis.observedAt }, new Date(basis.observedAt).toLocaleString())) : null) : null) : null, relevantError ? /* @__PURE__ */ import_react4.default.createElement("div", { className: "hse-context-error" }, relevantError) : null, currentLatest?.status === "error" && freshness !== "EXPIRED" ? /* @__PURE__ */ import_react4.default.createElement(HarborErrorState, { error: currentLatest.error, t }) : null, stale && reanalyzeLatest ? /* @__PURE__ */ import_react4.default.createElement("div", { className: "hse-copilot-actions" }, /* @__PURE__ */ import_react4.default.createElement("button", { type: "button", onClick: () => void reanalyzeLatest(discussionContext) }, t("reanalyzeLatest"))) : null, !references.length && action ? /* @__PURE__ */ import_react4.default.createElement("div", { className: "hse-copilot-actions" }, /* @__PURE__ */ import_react4.default.createElement("button", { type: "button", onClick: () => bridge.navigate(sessionId, action, { force: true }) }, t("viewInHarbor"))) : null) : null);
}
function MetricPills({ metrics }) {
  return /* @__PURE__ */ import_react4.default.createElement("div", { className: "hse-metrics" }, Object.entries(metrics ?? {}).map(([key, value]) => /* @__PURE__ */ import_react4.default.createElement("span", { className: "hse-pill", key }, key, /* @__PURE__ */ import_react4.default.createElement("b", null, format2(value)))));
}
function JobCard({ job, t, open, ask }) {
  ...
  return /* @__PURE__ */ import_react4.default.createElement("article", { className: "hse-job" }, /* @__PURE__ */ import_react4.default.createElement("button", { type: "button", className: "hse-job-open", onClick: () => open(job.name) }, /* @__PURE__ */ import_react4.default.createElement("div", { className: "hse-job-body" }, /* @__PURE__ */ import_react4.default.createElement("div", { className: "hse-job-top" }, /* @__PURE__ */ import_react4.default.createElement("div", { className: "hse-job-title" }, /* @__PURE__ */ import_react4.default.createElement("strong", null, job.name), /* @__PURE__ */ import_react4.default.createElement("span", { className: "hse-attention-label", "data-kind": attention.kind }, t(`health_${attention.kind}`), attention.count ? ` \xB7 ${attention.count} Trials / conditions` : ""), /* @__PURE__ */ import_react4.default.createElement("small", null, new Date(job.updatedAt).toLocaleString(), " \xB7 ", progress.health ?? "\u2014")), /* @__PURE__ */ import_react4.default.createElement("span", { className: "hse-status", "data-status": job.status }, t(job.status))), historical ? /* @__PURE__ */ import_react4.default.createElement("div", { className: "hse-meta-grid" }, /* @__PURE__ */ import_react4.default.createElement("div", { className: "hse-meta" }, /* @__PURE__ */ import_react4.default.createElement("span", null, t("historicalTarget")), /* @__PURE__ */ import_react4.default.createElement("b", null, target.source_kind ?? job.generationSource?.kind ?? "\u2014", " \xB7 ", target.record_count ?? job.nTrials ?? 0, " ", t("generationRecords"))), /* @__PURE__ */ import_react4.default.createElement("div", { className: "hse-meta" }, /* @__PURE__ */ import_react4.default.createElement("span", null, t("generatorPopulation")), /* @__PURE__ */ import_react4.default.createElement("b", null, generatorPopulationText(job.generatorPopulation ?? target.generator_population, t))), /* @__PURE__ */ import_react4.default.createElement("div", { className: "hse-meta" }, /* @__PURE__ */ import_react4.default.createElement("span", null, t("executionMode")), /* @__PURE__ */ import_react4.default.createElement("b", null, job.executionMode ?? t("observationMode"), " \xB7 ", t("gateNotApplicable"))), /* @__PURE__ */ import_react4.default.createElement("div", { className: "hse-meta" }, /* @__PURE__ */ import_react4.default.createElement("span", null, t("progress")), /* @__PURE__ */ import_react4.default.createElement("b", null, progress.completed ?? 0, "/", progress.total ?? job.nTrials ?? 0)), /* @__PURE__ */ import_react4.default.createElement("div", { className: "hse-meta" }, /* @__PURE__ */ import_react4.default.createElement("span", null, t("scoredTrials")), /* @__PURE__ */ import_react4.default.createElement("b", null, coverage.scored_trials ?? job.nValidScores ?? "\u2014", " / ", coverage.total_trials ?? job.nTrials ?? "\u2014")), /* @__PURE__ */ import_react4.default.createElement("div", { className: "hse-meta" }, /* @__PURE__ */ import_react4.default.createElement("span", null, t("unscoredTrials")), /* @__PURE__ */ import_react4.default.createElement("b", null, coverage.unscored_trials ?? job.nUnscoredTrials ?? 0, " \xB7 completed-unscored"))) : /* @__PURE__ */ import_react4.default.createElement("div", { className: "hse-meta-grid" }, /* @__PURE__ */ import_react4.default.createElement("div", { className: "hse-meta" }, /* @__PURE__ */ import_react4.default.createElement("span", null, t("candidate")), /* @__PURE__ */ import_react4.default.createElement("b", null, candidate.candidate_id ?? "\u2014", " \xB7 ", candidate.version ?? "\u2014")), /* @__PURE__ */ import_react4.default.createElement("div", { className: "hse-meta" }, /* @__PURE__ */ import_react4.default.createElement("span", null, t("dataset")), /* @__PURE__ */ import_react4.default.createElement("b", null, job.dataset?.dataset_id ?? "\u2014", " \xB7 ", job.dataset?.version ?? "\u2014")), /* @__PURE__ */ import_react4.default.createElement("div", { className: "hse-meta" }, /* @__PURE__ */ import_react4.default.createElement("span", null, t("mode")), /* @__PURE__ */ import_react4.default.createElement("b", null, job.mode ?? "\u2014")), /* @__PURE__ */ import_react4.default.createElement("div", { className: "hse-meta" }, /* @__PURE__ */ import_react4.default.createElement("span", null, t("progress")), /* @__PURE__ */ import_react4.default.createElement("b", null, progress.completed ?? 0, "/", progress.total ?? job.nTrials ?? 0)), /* @__PURE__ */ import_react4.default.createElement("div", { className: "hse-meta" }, /* @__PURE__ */ import_react4.default.createElement("span", null, t("validity")), /* @__PURE__ */ import_react4.default.createElement("b", null, typeof job.nValidScores === "number" ? `${t("validScores")} ${job.nValidScores}` : t("unavailable"))), /* @__PURE__ */ import_react4.default.createElement("div", { className: "hse-meta" }, /* @__PURE__ */ import_react4.default.createElement("span", null, t("exceptions")), /* @__PURE__ */ import_react4.default.createElement("b", null, job.nExceptions))), /* @__PURE__ */ import_react4.default.createElement("div", { className: "hse-progress", "aria-label": `${progress.percent ?? 0}%` }, /* @__PURE__ */ import_react4.default.createElement("i", { style: { width: `${progress.percent ?? 0}%` } })), /* @__PURE__ */ import_react4.default.createElement(MetricPills, { metrics: job.metrics }))), /* @__PURE__ */ import_react4.default.createElement("button", { type: "button", className: "hse-job-ask", onClick: () => void ask(job) }, t("askAi")));
}
function JsonSection({ title, value }) {
  return /* @__PURE__ */ import_react4.default.createElement("section", { className: "hse-section" }, /* @__PURE__ */ import_react4.default.createElement("h3", null, title), value ? /* @__PURE__ */ import_react4.default.createElement("pre", { className: "hse-source" }, pretty2(value)) : /* @__PURE__ */ import_react4.default.createElement("span", { className: "hse-muted" }, "\u2014"));
}
...
function TrialIssueActions({ detail, focused, onAsk, t }) {
  ...
  return /* @__PURE__ */ import_react4.default.createElement("section", { className: "hse-detail-group", ref, "data-highlight": String(selected) }, /* @__PURE__ */ import_react4.default.createElement("h4", null, t("exceptions"), " / ", t("validity")), objects.map((object, index) => /* @__PURE__ */ import_react4.default.createElement("p", { key: object.id }, reasons[index] ?? detail.lifecycle?.exception?.classification ?? detail.lifecycle?.exception?.type ?? t("exceptions"), " ", /* @__PURE__ */ import_react4.default.createElement("button", { type: "button", className: "hse-inline-ask", onClick: () => void onAsk({ localObject: object }, t("askFinding")) }, t("askAboutThis")))));
}
function TrialDetail({ state, t, focused, onFocus, onAsk, retry }) {
  const focusNodes = (0, import_react4.useRef)(/* @__PURE__ */ new Map());
  ...
  if (state?.status === "loading") return /* @__PURE__ */ import_react4.default.createElement("div", { className: "hse-trial-detail" }, /* @__PURE__ */ import_react4.default.createElement(HarborSkeleton, { kind: "trial-detail", rows: 7, label: t("loadingTrial") }));
  if (state?.status === "error") return /* @__PURE__ */ import_react4.default.createElement("div", { className: "hse-trial-detail" }, /* @__PURE__ */ import_react4.default.createElement(HarborErrorState, { error: state.error, retry, t }));
  if (!detail) return /* @__PURE__ */ import_react4.default.createElement("div", { className: "hse-trial-detail hse-muted" }, t("selectTrialHint"));
  const assessment = detail.assessment;
  const attemptObject = detail.interactionObjects?.find((ref) => ref.kind === "attempt");
  if (!assessment) return /* @__PURE__ */ import_react4.default.createElement("div", { className: "hse-trial-detail" }, /* @__PURE__ */ import_react4.default.createElement(TrialIssueActions, { detail, focused, onAsk, t }), attemptObject ? /* @__PURE__ */ import_react4.default.createElement("button", { type: "button", className: "hse-inline-ask", onClick: () => void onAsk({ localObject: attemptObject }, t("askAttempt")) }, t("askAboutThis"), " \xB7 ", t("attempt")) : null, /* @__PURE__ */ import_react4.default.createElement("div", { className: "hse-trial-score" }, /* @__PURE__ */ import_react4.default.createElement("div", null, /* @__PURE__ */ import_react4.default.createElement("span", null, detail.lifecycle?.name ?? detail.trial), /* @__PURE__ */ import_react4.default.createElement("b", null, "\u2014")), /* @__PURE__ */ import_react4.default.createElement("span", null, detail.status)), /* @__PURE__ */ import_react4.default.createElement("div", { className: "hse-detail-group" }, /* @__PURE__ */ import_react4.default.createElement("h4", null, t("currentStatus")), /* @__PURE__ */ import_react4.default.createElement("pre", null, pretty2(detail.lifecycle))));
  ...
  return /* @__PURE__ */ import_react4.default.createElement("article", { className: "hse-trial-detail", "aria-live": "polite" }, /* @__PURE__ */ import_react4.default.createElement("div", { className: "hse-trial-score" }, /* @__PURE__ */ import_react4.default.createElement("div", null, /* @__PURE__ */ import_react4.default.createElement("span", null, t("score")), /* @__PURE__ */ import_react4.default.createElement("b", null, score.valid ? format2(score.value) : "\u2014")), /* @__PURE__ */ import_react4.default.createElement("span", { className: unscored ? "hse-muted" : score.valid ? "hse-valid" : "hse-invalid" }, unscored ? "completed-unscored" : score.valid ? `\u2713 ${t("valid")}` : `\xD7 ${t("invalid")}`)), /* @__PURE__ */ import_react4.default.createElement(TrialIssueActions, { detail, focused, onAsk, t }), /* @__PURE__ */ import_react4.default.createElement("div", { className: "hse-detail-group" }, /* @__PURE__ */ import_react4.default.createElement("h4", null, t("findings")), /* @__PURE__ */ import_react4.default.createElement("ul", null, (assessment.findings ?? []).length ? assessment.findings.map((item, index) => /* @__PURE__ */ import_react4.default.createElement("li", { key: index, ref: (node) => ownFocusNode(`local:${findingObjects[index]?.id}`, node), "data-highlight": String(Boolean(findingObjects[index]?.id) && focused?.localObject?.id === findingObjects[index]?.id) }, item.code ? `${item.code}: ` : "", item.message ?? String(item), findingObjects[index] ? /* @__PURE__ */ import_react4.default.createElement("button", { type: "button", className: "hse-inline-ask", onClick: () => void onAsk({ localObject: findingObjects[index] }, t("askFinding")) }, t("askAboutThis")) : null)) : /* @__PURE__ */ import_react4.default.createElement("li", null, "\u2014"))), /* @__PURE__ */ import_react4.default.createElement("div", { className: "hse-detail-group" }, /* @__PURE__ */ import_react4.default.createElement("h4", null, t("recommendations")), /* @__PURE__ */ import_react4.default.createElement("ul", null, (assessment.recommendations ?? []).length ? assessment.recommendations.map((item, index) => /* @__PURE__ */ import_react4.default.createElement("li", { key: index }, item.message ?? String(item))) : /* @__PURE__ */ import_react4.default.createElement("li", null, "\u2014"))), /* @__PURE__ */ import_react4.default.createElement("div", { className: "hse-detail-group" }, /* @__PURE__ */ import_react4.default.createElement("h4", null, t("output")), /* @__PURE__ */ import_react4.default.createElement(ArtifactPreview, { detail, t })), /* @__PURE__ */ import_react4.default.createElement("div", { className: "hse-detail-group" }, /* @__PURE__ */ import_react4.default.createElement("h4", null, t("criteria")), /* @__PURE__ */ import_react4.default.createElement("div", { className: "hse-criteria" }, criteria.map((item) => /* @__PURE__ */ import_react4.default.createElement("div", { ref: (node) => ownFocusNode(`criterion:${item.id}`, node), className: "hse-criterion", "data-highlight": String(focused?.criterion === item.id), key: item.id, role: "button", tabIndex: 0, onClick: () => onFocus({ criterion: item.id }), onKeyDown: (event) => {
    if (event.key === "Enter" || event.key === " ") onFocus({ criterion: item.id });
  } }, /* @__PURE__ */ import_react4.default.createElement("span", null, item.label ?? item.id), /* @__PURE__ */ import_react4.default.createElement("b", null, format2(item.score)), /* @__PURE__ */ import_react4.default.createElement("button", { type: "button", className: "hse-inline-ask", onClick: (event) => {
    event.stopPropagation();
    void onAsk({ criterion: item.id }, t("suggestedQuestion1"));
  } }, t("askAi")), (item.evidence_refs ?? []).map((ref) => /* @__PURE__ */ import_react4.default.createElement("button", { ref: (node) => ownFocusNode(evidenceFocusKey(item.id, ref), node), type: "button", className: "hse-inline-ask", "data-highlight": String(isEvidenceFocused(focused, item.id, ref)), key: ref, onClick: (event) => {
    event.stopPropagation();
    void onAsk({ criterion: item.id, evidenceRef: ref }, t("suggestedQuestion3"));
  } }, t("evidence"), " \xB7 ", short(ref))))))), /* @__PURE__ */ import_react4.default.createElement("div", { className: "hse-detail-group" }, /* @__PURE__ */ import_react4.default.createElement("h4", null, t("provenance")), /* @__PURE__ */ import_react4.default.createElement("div", { className: "hse-provenance" }, (assessment.evidence_provenance ?? assessment.evidence ?? []).map((item, index) => {
    ...
    return /* @__PURE__ */ import_react4.default.createElement("button", { type: "button", disabled: !enabled, "data-highlight": String(enabled && isEvidenceFocused(focused, owners[0], ref)), key: ref ?? index, title: enabled ? item.artifact_ref : t("chooseCriterionEvidence"), onClick: () => enabled && void onAsk({ criterion: owners[0], evidenceRef: ref }, t("suggestedQuestion3")) }, item.label ?? item.kind ?? "Evidence");
  }))), /* @__PURE__ */ import_react4.default.createElement("div", { className: "hse-detail-group", ref: (node) => ownFocusNode(`local:${attemptObject?.id}`, node), "data-highlight": String(Boolean(attemptObject?.id) && focused?.localObject?.id === attemptObject?.id) }, /* @__PURE__ */ import_react4.default.createElement("h4", null, t("timing")), attemptObject ? /* @__PURE__ */ import_react4.default.createElement("button", { type: "button", className: "hse-inline-ask", onClick: () => void onAsk({ localObject: attemptObject }, t("askAttempt")) }, t("askAboutThis"), " \xB7 ", t("attempt"), " ", detail.lifecycle?.attempt) : null, /* @__PURE__ */ import_react4.default.createElement("pre", null, pretty2(assessment.process ?? detail.lifecycle))), /* @__PURE__ */ import_react4.default.createElement("details", { className: "hse-detail-group" }, /* @__PURE__ */ import_react4.default.createElement("summary", null, t("audit")), /* @__PURE__ */ import_react4.default.createElement("pre", null, pretty2(assessment))));
}
...
function TrialSelectionBar({ job, workspace, checked, setChecked, page, filters, contextFor, setContext, askContext, t }) {
  ...
  const owner = (0, import_react4.useRef)(0);
  const previousSnapshot = (0, import_react4.useRef)();
  (0, import_react4.useEffect)(() => {
    owner.current += 1;
  ...
  return /* @__PURE__ */ import_react4.default.createElement("div", { className: "hse-selection-bar" }, /* @__PURE__ */ import_react4.default.createElement("strong", null, t("selectedCount"), ": ", state.value?.count ?? checked.length, state.value ? ` \xB7 ${state.value.mode}` : ""), /* @__PURE__ */ import_react4.default.createElement("div", { className: "hse-local-actions" }, /* @__PURE__ */ import_react4.default.createElement("button", { type: "button", onClick: () => setChecked([.../* @__PURE__ */ new Set([...checked, ...(page?.items ?? []).map((trial) => trial.id)])]) }, t("allVisible")), /* @__PURE__ */ import_react4.default.createElement("button", { type: "button", disabled: !page?.total || state.status === "loading", onClick: () => void select("query-snapshot") }, t("selectFiltered"), " (", page?.total ?? 0, ")"), /* @__PURE__ */ import_react4.default.createElement("button", { type: "button", disabled: state.status === "loading" || !checked.length && !state.value, onClick: () => state.value ? void askContext(state.context, t("askSelected")) : void select("explicit", true) }, t("askSelected")), /* @__PURE__ */ import_react4.default.createElement("button", { type: "button", disabled: state.status === "loading" || !(state.value?.count ?? checked.length) || (state.value?.count ?? checked.length) > 12, onClick: () => state.value ? void askContext(state.context, t("askDiagnostic")) : void select("explicit", true, t("askDiagnostic")) }, t("prepareDiagnostic"), " (1\u201312)"), /* @__PURE__ */ import_react4.default.createElement("button", { type: "button", onClick: () => {
    owner.current += 1;
    setChecked([]);
    setState({ status: "idle" });
    setContext(contextFor({}));
  } }, t("clearSelection"))), state.status === "loading" ? /* @__PURE__ */ import_react4.default.createElement("small", null, t("bindingContext")) : null, state.value ? /* @__PURE__ */ import_react4.default.createElement("details", null, /* @__PURE__ */ import_react4.default.createElement("summary", null, t("contextIdentity")), /* @__PURE__ */ import_react4.default.createElement("code", null, state.value.ref.sourceDigest, " \xB7 ", state.value.filterDigest, " \xB7 ", state.value.expiresAt)) : null, state.error ? /* @__PURE__ */ import_react4.default.createElement(HarborErrorState, { error: state.error, t }) : null);
}
function TrialExplorer({ job, workspace, active, navigation, restoreView, onViewStateChange, onRestoreReady, onRestoreCancel, contextFor, setContext, resetContext, askContext, t }) {
  ...
  const [selectionError, setSelectionError] = (0, import_react4.useState)();
  const selectionSequence = (0, import_react4.useRef)(0);
  (0, import_react4.useEffect)(() => () => {
  ...
  (0, import_react4.useEffect)(() => {
    ...
    void requestApi("selection-detail", { workspace, ...ref }).then((value) => {
      ...
      setContext(contextFor({ trial: void 0, selections: [value.ref] }));
    }, (error) => {
      if (sequence === selectionSequence.current) setSelectionError(normalizeHarborUiError(error));
    });
    return () => {
  ...
  const [validity, setValidity] = (0, import_react4.useState)("");
  const [sort, setSort] = (0, import_react4.useState)("dataset-order");
  const [offset, setOffset] = (0, import_react4.useState)(0);
  const [listState, setListState] = (0, import_react4.useState)({ status: "loading", stale: false });
  const [listRetry, setListRetry] = (0, import_react4.useState)(0);
  const [selected, setSelected] = (0, import_react4.useState)();
  const [detailState, setDetailState] = (0, import_react4.useState)({ status: "empty" });
  const [focused, setFocused] = (0, import_react4.useState)({});
  const [restoreSettled, setRestoreSettled] = (0, import_react4.useState)();
  const detailSequence = (0, import_react4.useRef)(0);
  const alive = (0, import_react4.useRef)(true);
  const handledNavigation = (0, import_react4.useRef)();
  const handledRestore = (0, import_react4.useRef)();
  const reportedRestore = (0, import_react4.useRef)();
  const restoreOwner = (0, import_react4.useRef)();
  const listRequestKey = (0, import_react4.useMemo)(
  ...
  const cancelPendingRestore = (0, import_react4.useCallback)(() => {
    restoreOwner.current = void 0;
    setRestoreSettled(void 0);
    onRestoreCancel?.();
  }, [onRestoreCancel]);
  const choose = (0, import_react4.useCallback)(async (trial, focus2 = {}, view = {}, restoreId) => {
  ...
  const selectionFilters = (0, import_react4.useMemo)(() => ({ query, status, validity, sort }), [query, status, validity, sort]);
  const emptyPage = Boolean(page && !page.items?.length);
  return /* @__PURE__ */ import_react4.default.createElement("div", { className: "hse-trial-layout" }, /* @__PURE__ */ import_react4.default.createElement("div", { className: "hse-trial-list" }, /* @__PURE__ */ import_react4.default.createElement("div", { className: "hse-trial-tools" }, /* @__PURE__ */ import_react4.default.createElement("input", { className: "hse-input", value: query, placeholder: t("search"), onChange: (event) => {
    cancelPendingRestore();
    setQuery(event.target.value);
    setOffset(0);
  } }), /* @__PURE__ */ import_react4.default.createElement("select", { className: "hse-select", value: status, onChange: (event) => {
    cancelPendingRestore();
    setStatus(event.target.value);
    setOffset(0);
  } }, /* @__PURE__ */ import_react4.default.createElement("option", { value: "" }, t("all")), /* @__PURE__ */ import_react4.default.createElement("option", { value: "completed" }, "completed"), /* @__PURE__ */ import_react4.default.createElement("option", { value: "completed-unscored" }, "completed-unscored"), /* @__PURE__ */ import_react4.default.createElement("option", { value: "candidate-quality-failed" }, "candidate-quality-failed"), /* @__PURE__ */ import_react4.default.createElement("option", { value: "infrastructure-error" }, "infrastructure-error"), /* @__PURE__ */ import_react4.default.createElement("option", { value: "evaluation-error" }, "evaluation-error"), /* @__PURE__ */ import_react4.default.createElement("option", { value: "running-agent" }, "running-agent"), /* @__PURE__ */ import_react4.default.createElement("option", { value: "evaluating" }, "evaluating")), /* @__PURE__ */ import_react4.default.createElement("select", { className: "hse-select", value: validity, onChange: (event) => {
    cancelPendingRestore();
    setValidity(event.target.value);
    setOffset(0);
  } }, /* @__PURE__ */ import_react4.default.createElement("option", { value: "" }, t("validity")), /* @__PURE__ */ import_react4.default.createElement("option", { value: "true" }, t("valid")), /* @__PURE__ */ import_react4.default.createElement("option", { value: "false" }, t("invalid"))), /* @__PURE__ */ import_react4.default.createElement("select", { className: "hse-select", value: sort, onChange: (event) => {
    cancelPendingRestore();
    setSort(event.target.value);
  } }, /* @__PURE__ */ import_react4.default.createElement("option", { value: "dataset-order" }, t("datasetOrder")), /* @__PURE__ */ import_react4.default.createElement("option", { value: "latest-completed" }, t("latest")), /* @__PURE__ */ import_react4.default.createElement("option", { value: "lowest-score" }, t("lowest")), /* @__PURE__ */ import_react4.default.createElement("option", { value: "errors" }, t("errorsFirst")))), selectionError ? /* @__PURE__ */ import_react4.default.createElement(HarborErrorState, { error: selectionError, t }) : null, /* @__PURE__ */ import_react4.default.createElement(TrialSelectionBar, { job, workspace, checked, setChecked, page, filters: selectionFilters, contextFor, setContext, askContext, t }), listState.error ? /* @__PURE__ */ import_react4.default.createElement(HarborErrorState, { error: listState.errorDetails ?? listState.error, title: listState.stale ? t("trialListStale") : t("trialListUnavailable"), retry: () => setListRetry((value) => value + 1), t }) : null, !page && listState.status === "loading" ? /* @__PURE__ */ import_react4.default.createElement(HarborSkeleton, { kind: "trial-list", rows: 6, label: t("loading") }) : emptyPage ? /* @__PURE__ */ import_react4.default.createElement("div", { className: "hse-filter-empty" }, /* @__PURE__ */ import_react4.default.createElement("b", null, filtered ? t("noFilteredTrials") : t("noData")), filtered ? /* @__PURE__ */ import_react4.default.createElement("button", { type: "button", onClick: clearFilters }, t("clearFilters")) : null) : page ? /* @__PURE__ */ import_react4.default.createElement(import_react4.default.Fragment, null, /* @__PURE__ */ import_react4.default.createElement("div", { className: "hse-table-wrap" }, /* @__PURE__ */ import_react4.default.createElement("table", { className: "hse-table" }, /* @__PURE__ */ import_react4.default.createElement("thead", null, /* @__PURE__ */ import_react4.default.createElement("tr", null, /* @__PURE__ */ import_react4.default.createElement("th", null, "#"), /* @__PURE__ */ import_react4.default.createElement("th", null, t("queryTrial")), /* @__PURE__ */ import_react4.default.createElement("th", null, t("statusLabel")), /* @__PURE__ */ import_react4.default.createElement("th", null, t("score")), /* @__PURE__ */ import_react4.default.createElement("th", null, t("attempt")))), /* @__PURE__ */ import_react4.default.createElement("tbody", null, page.items?.map((trial) => {
    const trialId = trial.id ?? trial.datasetTrial;
    return /* @__PURE__ */ import_react4.default.createElement("tr", { key: `${trial.id}-${trial.attempt}`, "data-selected": String(selected) === String(trialId) }, /* @__PURE__ */ import_react4.default.createElement("td", null, /* @__PURE__ */ import_react4.default.createElement("input", { type: "checkbox", "aria-label": `${t("selectTrial")} ${trialId}`, checked: checked.includes(trialId), onChange: (event) => setChecked((current) => event.target.checked ? [.../* @__PURE__ */ new Set([...current, trialId])] : current.filter((id) => id !== trialId)) }), trial.datasetOrder + 1), /* @__PURE__ */ import_react4.default.createElement("td", null, /* @__PURE__ */ import_react4.default.createElement("div", { className: "hse-trial-name" }, /* @__PURE__ */ import_react4.default.createElement("button", { onClick: () => void choose(trialId) }, trial.displayName ?? trial.datasetTrial ?? trial.name), /* @__PURE__ */ import_react4.default.createElement("button", { type: "button", className: "hse-trial-ask", onClick: () => void askTrial(trialId) }, t("askAi")))), /* @__PURE__ */ import_react4.default.createElement("td", null, trial.status), /* @__PURE__ */ import_react4.default.createElement("td", null, trial.score?.valid ? format2(trial.score.value ?? trial.rewards?.reward) : "\u2014"), /* @__PURE__ */ import_react4.default.createElement("td", null, trial.attempt));
  })))), /* @__PURE__ */ import_react4.default.createElement("div", { className: "hse-pager" }, /* @__PURE__ */ import_react4.default.createElement("span", null, page.total ? `${offset + 1}\u2013${Math.min(offset + (page.items?.length ?? 0), page.total)} / ${page.total}` : "0 / 0"), /* @__PURE__ */ import_react4.default.createElement("button", { disabled: !offset, onClick: () => {
    cancelPendingRestore();
    setOffset(Math.max(0, offset - 100));
  } }, t("previous")), /* @__PURE__ */ import_react4.default.createElement("button", { disabled: !page.hasMore, onClick: () => {
    cancelPendingRestore();
    setOffset(offset + 100);
  } }, t("next")))) : null), /* @__PURE__ */ import_react4.default.createElement(TrialDetail, { state: detailState, focused, onFocus: focus, onAsk: ask, retry: retryDetail, t }));
}
function DatasetPanel({ job, workspace, artifacts, t }) {
  ...
  return /* @__PURE__ */ import_react4.default.createElement(import_react4.default.Fragment, null, /* @__PURE__ */ import_react4.default.createElement("section", { className: "hse-section" }, /* @__PURE__ */ import_react4.default.createElement("div", { className: "hse-grid" }, /* @__PURE__ */ import_react4.default.createElement("div", { className: "hse-card" }, /* @__PURE__ */ import_react4.default.createElement("span", null, "ID / version"), /* @__PURE__ */ import_react4.default.createElement("b", null, artifacts.dataset?.dataset_id ?? "\u2014", " \xB7 ", artifacts.dataset?.version ?? "\u2014"), /* @__PURE__ */ import_react4.default.createElement("code", null, short(artifacts.dataset?.source_digest))), /* @__PURE__ */ import_react4.default.createElement("div", { className: "hse-card" }, /* @__PURE__ */ import_react4.default.createElement("span", null, t("population")), /* @__PURE__ */ import_react4.default.createElement("b", null, artifacts.dataset?.task_count ?? dataset?.task_count ?? 0), /* @__PURE__ */ import_react4.default.createElement("code", null, badcases, " ", t("badcase"), " \xB7 ", dataset?.source === "job-snapshot" ? t("snapshot") : dataset?.source === "historical-source-fallback" ? t("historicalFallback") : "\u2014")))), /* @__PURE__ */ import_react4.default.createElement("section", { className: "hse-section" }, /* @__PURE__ */ import_react4.default.createElement("h3", null, t("datasetTasks")), state.error ? /* @__PURE__ */ import_react4.default.createElement(HarborErrorState, { error: state.error, retry: () => setRetry((value) => value + 1), t }) : null, state.status === "loading" && !dataset ? /* @__PURE__ */ import_react4.default.createElement(HarborSkeleton, { kind: "dataset", rows: 5, label: t("loading") }) : dataset ? /* @__PURE__ */ import_react4.default.createElement("div", { className: "hse-task-list" }, (dataset.tasks ?? []).map((task, index) => /* @__PURE__ */ import_react4.default.createElement("details", { className: "hse-task", key: task.id ?? index, open: index === 0 }, /* @__PURE__ */ import_react4.default.createElement("summary", null, index + 1, ". ", task.query || task.id || `task-${index + 1}`, /* @__PURE__ */ import_react4.default.createElement("span", { className: task.metadata?.badcase ? "hse-badcase" : void 0 }, task.metadata?.badcase ? `${t("badcase")} \xB7 ${task.metadata?.case_type}` : task.metadata?.topic ?? task.id ?? "\u2014")), /* @__PURE__ */ import_react4.default.createElement("div", { className: "hse-task-body" }, /* @__PURE__ */ import_react4.default.createElement("h4", null, t("taskInstruction")), task.instruction ? /* @__PURE__ */ import_react4.default.createElement("pre", { className: "hse-instruction" }, task.instruction) : /* @__PURE__ */ import_react4.default.createElement("div", { className: "hse-capability" }, task.instruction_error ?? t("noData")), /* @__PURE__ */ import_react4.default.createElement("div", { className: "hse-inline-meta" }, /* @__PURE__ */ import_react4.default.createElement("span", null, "ID: ", task.id ?? "\u2014"), /* @__PURE__ */ import_react4.default.createElement("span", null, t("instructionFile"), ": ", task.instruction_file ?? "\u2014"), /* @__PURE__ */ import_react4.default.createElement("span", null, t("datasetSource"), ": ", dataset.source === "job-snapshot" ? t("snapshot") : t("historicalFallback")), task.instruction_truncated ? /* @__PURE__ */ import_react4.default.createElement("span", null, t("attention")) : null))))) : null));
}
...
function CandidatePanel({ artifacts, t }) {
  ...
  return /* @__PURE__ */ import_react4.default.createElement(import_react4.default.Fragment, null, /* @__PURE__ */ import_react4.default.createElement("section", { className: "hse-section" }, /* @__PURE__ */ import_react4.default.createElement("h3", null, t("experimentIdentity")), /* @__PURE__ */ import_react4.default.createElement("p", { className: "hse-muted" }, t("experimentIdentityHint")), /* @__PURE__ */ import_react4.default.createElement("div", { className: "hse-identity-grid" }, /* @__PURE__ */ import_react4.default.createElement("div", { className: "hse-card" }, /* @__PURE__ */ import_react4.default.createElement("span", null, t("candidate")), /* @__PURE__ */ import_react4.default.createElement("b", null, candidate.candidate_id ?? "\u2014", " \xB7 ", candidate.version ?? "\u2014"), /* @__PURE__ */ import_react4.default.createElement("code", null, short(candidate.digest))), /* @__PURE__ */ import_react4.default.createElement("div", { className: "hse-card" }, /* @__PURE__ */ import_react4.default.createElement("span", null, t("dataset")), /* @__PURE__ */ import_react4.default.createElement("b", null, dataset.dataset_id ?? "\u2014", " \xB7 ", dataset.version ?? "\u2014"), /* @__PURE__ */ import_react4.default.createElement("code", null, dataset.task_count ?? "\u2014", " Tasks \xB7 ", short(dataset.source_digest))), /* @__PURE__ */ import_react4.default.createElement("div", { className: "hse-card" }, /* @__PURE__ */ import_react4.default.createElement("span", null, t("evaluationStack")), /* @__PURE__ */ import_react4.default.createElement("b", null, stack.stack_id ?? "\u2014", " \xB7 ", stack.version ?? "\u2014"), /* @__PURE__ */ import_react4.default.createElement("code", null, short(stack.comparison_digest ?? stack.digest))), /* @__PURE__ */ import_react4.default.createElement("div", { className: "hse-card" }, /* @__PURE__ */ import_react4.default.createElement("span", null, t("runtime")), /* @__PURE__ */ import_react4.default.createElement("b", null, "Harbor ", runtime.harbor_version ?? "\u2014"), /* @__PURE__ */ import_react4.default.createElement("code", null, candidate.runtime?.kind ?? "\u2014", " \xB7 ", candidate.runtime?.version ?? "\u2014", " \xB7 ", context.mode ?? "\u2014")))), /* @__PURE__ */ import_react4.default.createElement("section", { className: "hse-section" }, /* @__PURE__ */ import_react4.default.createElement("h3", null, t("immutableCandidateFiles")), /* @__PURE__ */ import_react4.default.createElement("div", { className: "hse-table-wrap" }, /* @__PURE__ */ import_react4.default.createElement("table", { className: "hse-evidence-table" }, /* @__PURE__ */ import_react4.default.createElement("thead", null, /* @__PURE__ */ import_react4.default.createElement("tr", null, /* @__PURE__ */ import_react4.default.createElement("th", null, t("file")), /* @__PURE__ */ import_react4.default.createElement("th", null, t("size")), /* @__PURE__ */ import_react4.default.createElement("th", null, t("digest")))), /* @__PURE__ */ import_react4.default.createElement("tbody", null, (candidate.files ?? []).map((file) => /* @__PURE__ */ import_react4.default.createElement("tr", { key: file.path }, /* @__PURE__ */ import_react4.default.createElement("td", null, file.path), /* @__PURE__ */ import_react4.default.createElement("td", null, file.size), /* @__PURE__ */ import_react4.default.createElement("td", null, /* @__PURE__ */ import_react4.default.createElement("code", null, short(file.sha256))))))))));
}
function HistoricalTargetPanel({ detail, artifacts, t }) {
  ...
  return /* @__PURE__ */ import_react4.default.createElement(import_react4.default.Fragment, null, /* @__PURE__ */ import_react4.default.createElement("section", { className: "hse-section" }, /* @__PURE__ */ import_react4.default.createElement("h3", null, t("historicalTarget")), /* @__PURE__ */ import_react4.default.createElement("p", { className: "hse-muted" }, t("observationMode")), /* @__PURE__ */ import_react4.default.createElement("div", { className: "hse-identity-grid" }, /* @__PURE__ */ import_react4.default.createElement("div", { className: "hse-card" }, /* @__PURE__ */ import_react4.default.createElement("span", null, t("batch")), /* @__PURE__ */ import_react4.default.createElement("b", null, target.batch_id ?? "\u2014"), /* @__PURE__ */ import_react4.default.createElement("code", null, short(target.digest))), /* @__PURE__ */ import_react4.default.createElement("div", { className: "hse-card" }, /* @__PURE__ */ import_react4.default.createElement("span", null, t("generationRecords")), /* @__PURE__ */ import_react4.default.createElement("b", null, target.record_count ?? coverage.total_trials ?? "\u2014", " Trials"), /* @__PURE__ */ import_react4.default.createElement("code", null, target.kind ?? "\u2014", " \xB7 ", target.source_kind ?? source.kind ?? "\u2014")), /* @__PURE__ */ import_react4.default.createElement("div", { className: "hse-card" }, /* @__PURE__ */ import_react4.default.createElement("span", null, t("generationSource")), /* @__PURE__ */ import_react4.default.createElement("b", null, source.kind ?? target.source_kind ?? "\u2014"), /* @__PURE__ */ import_react4.default.createElement("code", null, source.adapter_id ?? adapter.adapter_id ?? adapter.id ?? "\u2014")), /* @__PURE__ */ import_react4.default.createElement("div", { className: "hse-card" }, /* @__PURE__ */ import_react4.default.createElement("span", null, t("executionMode")), /* @__PURE__ */ import_react4.default.createElement("b", null, detail?.executionMode ?? summary.execution_mode ?? context.execution_mode ?? "\u2014"), /* @__PURE__ */ import_react4.default.createElement("code", null, context.protocol ?? "\u2014")))), /* @__PURE__ */ import_react4.default.createElement("section", { className: "hse-section" }, /* @__PURE__ */ import_react4.default.createElement("h3", null, t("generatorPopulation")), /* @__PURE__ */ import_react4.default.createElement("div", { className: "hse-grid" }, /* @__PURE__ */ import_react4.default.createElement("div", { className: "hse-card" }, /* @__PURE__ */ import_react4.default.createElement("span", null, population?.homogeneous === false ? t("mixedPopulation") : population?.homogeneous === true ? t("homogeneousPopulation") : t("generatorPopulation")), /* @__PURE__ */ import_react4.default.createElement("b", null, generatorPopulationText(population, t)), /* @__PURE__ */ import_react4.default.createElement("code", null, population ? short(population.digest) : "\u2014")), /* @__PURE__ */ import_react4.default.createElement("div", { className: "hse-card" }, /* @__PURE__ */ import_react4.default.createElement("span", null, t("coverage")), /* @__PURE__ */ import_react4.default.createElement("b", null, coverage.scored_trials ?? "\u2014", " / ", coverage.total_trials ?? target.record_count ?? "\u2014"), /* @__PURE__ */ import_react4.default.createElement("code", null, t("unscoredTrials"), ": ", coverage.unscored_trials ?? 0, " \xB7 completed-unscored")), /* @__PURE__ */ import_react4.default.createElement("div", { className: "hse-card" }, /* @__PURE__ */ import_react4.default.createElement("span", null, "Trial coverage"), /* @__PURE__ */ import_react4.default.createElement("b", null, typeof coverage.trial_rate === "number" ? `${format2(coverage.trial_rate * 100)}%` : "\u2014"), /* @__PURE__ */ import_react4.default.createElement("code", null, t("scoredTrials"))), /* @__PURE__ */ import_react4.default.createElement("div", { className: "hse-card" }, /* @__PURE__ */ import_react4.default.createElement("span", null, "Criterion coverage"), /* @__PURE__ */ import_react4.default.createElement("b", null, coverage.criterion_scored ?? "\u2014", " / ", coverage.criterion_total ?? "\u2014"), /* @__PURE__ */ import_react4.default.createElement("code", null, typeof coverage.criterion_rate === "number" ? `${format2(coverage.criterion_rate * 100)}%` : "\u2014")))));
}
function ContractPanel({ artifacts, component, t }) {
  const contract = artifacts.contract ?? {};
  return /* @__PURE__ */ import_react4.default.createElement(import_react4.default.Fragment, null, /* @__PURE__ */ import_react4.default.createElement("section", { className: "hse-section" }, /* @__PURE__ */ import_react4.default.createElement("h3", null, t("integrationBoundary")), /* @__PURE__ */ import_react4.default.createElement("div", { className: "hse-grid" }, /* @__PURE__ */ import_react4.default.createElement("div", { className: "hse-card" }, /* @__PURE__ */ import_react4.default.createElement("span", null, t("integration")), /* @__PURE__ */ import_react4.default.createElement("b", null, component?.id ?? "\u2014", " \xB7 ", component?.version ?? "\u2014"), /* @__PURE__ */ import_react4.default.createElement("code", null, short(component?.digest))), /* @__PURE__ */ import_react4.default.createElement("div", { className: "hse-card" }, /* @__PURE__ */ import_react4.default.createElement("span", null, t("scoringContract")), /* @__PURE__ */ import_react4.default.createElement("b", null, contract.contract_id ?? "\u2014", " \xB7 ", contract.version ?? "\u2014"), /* @__PURE__ */ import_react4.default.createElement("code", null, t("primaryMetric"), ": ", contract.primary_metric ?? "\u2014")))), /* @__PURE__ */ import_react4.default.createElement("section", { className: "hse-section" }, /* @__PURE__ */ import_react4.default.createElement("h3", null, t("hardRequirements")), /* @__PURE__ */ import_react4.default.createElement("div", { className: "hse-chip-list" }, (contract.hard_requirements ?? []).map((item) => /* @__PURE__ */ import_react4.default.createElement("span", { key: item.id ?? item }, item.id ?? item)))));
}
function ArtifactPreview({ detail, t }) {
  const preview = detail?.preview;
  if (!preview) return /* @__PURE__ */ import_react4.default.createElement("div", { className: "hse-preview" }, /* @__PURE__ */ import_react4.default.createElement("div", { className: "hse-preview-empty" }, t("noRenderableOutput")));
  const content = preview.content;
  const provenance = preview.provenance ?? [];
  let body;
  if (preview.kind === "page" && preview.format === "url" && preview.url) body = /* @__PURE__ */ import_react4.default.createElement("iframe", { className: "hse-page-frame", title: preview.title ?? t("pagePreview"), src: preview.url, sandbox: "", referrerPolicy: "no-referrer" });
  else if (preview.kind === "page" && preview.format === "html" && typeof content === "string") body = /* @__PURE__ */ import_react4.default.createElement("iframe", { className: "hse-page-frame", title: preview.title ?? t("pagePreview"), srcDoc: content, sandbox: "", referrerPolicy: "no-referrer" });
    ...
    body = /* @__PURE__ */ import_react4.default.createElement("div", { className: "hse-document" }, /* @__PURE__ */ import_react4.default.createElement("h4", null, t("documentPreview")), /* @__PURE__ */ import_react4.default.createElement("pre", null, primary ?? pretty2(content)), remainder && Object.keys(remainder).length ? /* @__PURE__ */ import_react4.default.createElement("details", { className: "hse-source-details" }, /* @__PURE__ */ import_react4.default.createElement("summary", null, t("rawOutput")), /* @__PURE__ */ import_react4.default.createElement("pre", { className: "hse-output-structured" }, pretty2(remainder))) : null);
  } else body = /* @__PURE__ */ import_react4.default.createElement("pre", { className: "hse-output-structured" }, pretty2(content));
  return /* @__PURE__ */ import_react4.default.createElement("article", { className: "hse-preview" }, /* @__PURE__ */ import_react4.default.createElement("header", { className: "hse-preview-head" }, /* @__PURE__ */ import_react4.default.createElement("div", null, /* @__PURE__ */ import_react4.default.createElement("b", null, preview.title ?? t("generatedOutput")), /* @__PURE__ */ import_react4.default.createElement("span", null, preview.kind, " \xB7 ", preview.format)), /* @__PURE__ */ import_react4.default.createElement("div", null, /* @__PURE__ */ import_react4.default.createElement("b", null, t("previewSource")), /* @__PURE__ */ import_react4.default.createElement("span", null, provenance.map((item) => item.label ?? item.kind).join(" \xB7 ") || preview.source || "\u2014"))), body);
}
function RendererPanel({ job, workspace, active, component, contextFor, setContext, askContext, navigation, t }) {
  ...
  return /* @__PURE__ */ import_react4.default.createElement(import_react4.default.Fragment, null, /* @__PURE__ */ import_react4.default.createElement("section", { className: "hse-section" }, /* @__PURE__ */ import_react4.default.createElement("div", { className: "hse-grid" }, /* @__PURE__ */ import_react4.default.createElement("div", { className: "hse-card" }, /* @__PURE__ */ import_react4.default.createElement("span", null, t("renderer")), /* @__PURE__ */ import_react4.default.createElement("b", null, component?.id ?? "\u2014", " \xB7 ", component?.version ?? "\u2014"), /* @__PURE__ */ import_react4.default.createElement("code", null, short(component?.digest))), /* @__PURE__ */ import_react4.default.createElement("div", { className: "hse-card" }, /* @__PURE__ */ import_react4.default.createElement("span", null, t("generatedOutput")), /* @__PURE__ */ import_react4.default.createElement("b", null, page?.items?.length ?? 0, " Trials"), /* @__PURE__ */ import_react4.default.createElement("code", null, t("previewSource"), ": ", detail?.preview?.provenance?.map((item) => item.label ?? item.kind).join(" \xB7 ") || "\u2014")))), /* @__PURE__ */ import_react4.default.createElement("section", { className: "hse-section" }, /* @__PURE__ */ import_react4.default.createElement("h3", null, t("generatedOutput")), listState.error ? /* @__PURE__ */ import_react4.default.createElement(HarborErrorState, { error: listState.errorDetails ?? listState.error, title: listState.stale ? t("trialListStale") : t("trialListUnavailable"), retry: () => setListRetry((value) => value + 1), t }) : null, !page && listState.status === "loading" ? /* @__PURE__ */ import_react4.default.createElement(HarborSkeleton, { kind: "renderer-list", rows: 5, label: t("loading") }) : /* @__PURE__ */ import_react4.default.createElement("div", { className: "hse-output-layout" }, /* @__PURE__ */ import_react4.default.createElement("div", { className: "hse-output-list" }, (page?.items ?? []).map((trial, index) => /* @__PURE__ */ import_react4.default.createElement("button", { type: "button", className: "hse-output-item", "data-active": String(selected) === String(trial.id ?? trial.datasetTrial), key: `${trial.id}-${trial.attempt}`, onClick: () => setSelected(trial.id ?? trial.datasetTrial) }, /* @__PURE__ */ import_react4.default.createElement("b", null, index + 1, ". ", trial.displayName ?? trial.datasetTrial ?? trial.name), /* @__PURE__ */ import_react4.default.createElement("span", null, trial.status, " \xB7 attempt ", trial.attempt)))), detailError ? /* @__PURE__ */ import_react4.default.createElement(HarborErrorState, { error: detailError, t }) : /* @__PURE__ */ import_react4.default.createElement(ArtifactPreview, { detail, t }))));
}
function TrialAssessmentReport({ job, workspace, active, artifacts, historical = false, contextFor, setContext, askContext, navigation, restoreView, onViewStateChange, t }) {
  ...
  const [listRetry, setListRetry] = (0, import_react4.useState)(0);
  const [selected, setSelected] = (0, import_react4.useState)();
  const [detailState, setDetailState] = (0, import_react4.useState)({ status: "idle" });
  const [focused, setFocused] = (0, import_react4.useState)({});
  const contextForRef = (0, import_react4.useRef)(contextFor);
  ...
  return /* @__PURE__ */ import_react4.default.createElement("section", { className: "hse-section" }, /* @__PURE__ */ import_react4.default.createElement("h3", null, t("trialAssessments")), /* @__PURE__ */ import_react4.default.createElement("p", { className: "hse-muted" }, t("trialAssessmentsHint")), listState.error ? /* @__PURE__ */ import_react4.default.createElement(HarborErrorState, { error: listState.errorDetails ?? listState.error, title: listState.stale ? t("trialListStale") : t("trialListUnavailable"), retry: () => setListRetry((value) => value + 1), t }) : null, !page && listState.status === "loading" ? /* @__PURE__ */ import_react4.default.createElement(HarborSkeleton, { kind: "report-trial-list", rows: 5, label: t("loading") }) : page ? /* @__PURE__ */ import_react4.default.createElement(import_react4.default.Fragment, null, /* @__PURE__ */ import_react4.default.createElement("div", { className: "hse-table-wrap" }, /* @__PURE__ */ import_react4.default.createElement("table", { className: "hse-evidence-table hse-report-table" }, /* @__PURE__ */ import_react4.default.createElement("thead", null, /* @__PURE__ */ import_react4.default.createElement("tr", null, /* @__PURE__ */ import_react4.default.createElement("th", null, "#"), /* @__PURE__ */ import_react4.default.createElement("th", null, t("queryTrial")), /* @__PURE__ */ import_react4.default.createElement("th", null, t("overallScore")), metricIds.map((id) => /* @__PURE__ */ import_react4.default.createElement("th", { key: id }, labels[id] ?? id)))), /* @__PURE__ */ import_react4.default.createElement("tbody", null, (page.items ?? []).map((trial) => /* @__PURE__ */ import_react4.default.createElement("tr", { key: `${trial.id}-${trial.attempt}`, "data-selected": String(selected) === String(trial.id ?? trial.datasetTrial) }, /* @__PURE__ */ import_react4.default.createElement("td", null, trial.datasetOrder + 1), /* @__PURE__ */ import_react4.default.createElement("td", null, /* @__PURE__ */ import_react4.default.createElement("button", { type: "button", onClick: () => choose(trial.id ?? trial.datasetTrial) }, trial.displayName ?? trial.datasetTrial ?? trial.name), /* @__PURE__ */ import_react4.default.createElement("button", { type: "button", className: "hse-inline-ask", onClick: () => void ask(trial.id ?? trial.datasetTrial) }, t("askAi"))), /* @__PURE__ */ import_react4.default.createElement("td", null, /* @__PURE__ */ import_react4.default.createElement("span", { className: "hse-report-score", "data-valid": trial.scoringStatus === "unscored" ? void 0 : trial.score?.valid }, trial.scoringStatus === "unscored" ? "completed-unscored" : trial.score?.valid ? format2(trial.score.value ?? trial.rewards?.[primary]) : "\u2014")), metricIds.map((id) => /* @__PURE__ */ import_react4.default.createElement("td", { key: id }, format2(trial.rewards?.[id])))))))), /* @__PURE__ */ import_react4.default.createElement("div", { className: "hse-pager" }, /* @__PURE__ */ import_react4.default.createElement("span", null, page.total ? `${offset + 1}\u2013${Math.min(offset + (page.items?.length ?? 0), page.total)} / ${page.total}` : "0 / 0"), /* @__PURE__ */ import_react4.default.createElement("button", { disabled: !offset, onClick: () => setOffset(Math.max(0, offset - REPORT_PAGE_SIZE)) }, t("previous")), /* @__PURE__ */ import_react4.default.createElement("button", { disabled: !page.hasMore, onClick: () => setOffset(offset + REPORT_PAGE_SIZE) }, t("next")))) : null, detailState.status === "loading" ? /* @__PURE__ */ import_react4.default.createElement(HarborSkeleton, { kind: "report-trial-detail", rows: 6, label: t("loading") }) : detailState.status === "error" ? /* @__PURE__ */ import_react4.default.createElement(HarborErrorState, { error: detailState.error, t }) : assessment ? /* @__PURE__ */ import_react4.default.createElement("article", { className: "hse-report-detail" }, /* @__PURE__ */ import_react4.default.createElement("header", { className: "hse-report-detail-head" }, /* @__PURE__ */ import_react4.default.createElement("div", null, /* @__PURE__ */ import_react4.default.createElement("h4", null, selectedTrial?.displayName ?? assessment.query ?? assessment.trial_name), /* @__PURE__ */ import_react4.default.createElement("span", null, t("artifact"), ": ", artifactTitle), /* @__PURE__ */ import_react4.default.createElement("code", null, assessment.dataset_trial ?? selectedTrial?.datasetTrial)), /* @__PURE__ */ import_react4.default.createElement("div", null, /* @__PURE__ */ import_react4.default.createElement("span", null, t("overallScore")), /* @__PURE__ */ import_react4.default.createElement("b", { className: selectedTrial?.scoringStatus === "unscored" ? "hse-muted" : score?.valid ? "hse-valid" : "hse-invalid" }, selectedTrial?.scoringStatus === "unscored" ? "completed-unscored" : score?.valid ? format2(score.value) : "\u2014"))), !score?.valid ? /* @__PURE__ */ import_react4.default.createElement("div", { className: "hse-capability" }, selectedTrial?.scoringStatus === "unscored" && historical ? `${t("unscoredTrials")} \xB7 ` : "", (score?.invalid_reasons ?? []).join(" \xB7 ")) : null, /* @__PURE__ */ import_react4.default.createElement("div", { className: "hse-report-compare" }, /* @__PURE__ */ import_react4.default.createElement("div", { className: "hse-report-criteria" }, (assessment.criteria ?? []).map((criterion) => /* @__PURE__ */ import_react4.default.createElement("section", { className: "hse-report-criterion", key: criterion.id, "data-highlight": String(focused.criterion === criterion.id), ref: (node) => {
    if (node && focused.criterion === criterion.id && navigation?.actionId) node.scrollIntoView?.({ block: "center" });
  } }, /* @__PURE__ */ import_react4.default.createElement("header", null, /* @__PURE__ */ import_react4.default.createElement("b", null, criterion.label ?? labels[criterion.id] ?? criterion.id), /* @__PURE__ */ import_react4.default.createElement("b", null, format2(criterion.score)), /* @__PURE__ */ import_react4.default.createElement("button", { type: "button", className: "hse-inline-ask", onClick: () => void ask(selected, { criterion: criterion.id }) }, t("askAboutThis"))), /* @__PURE__ */ import_react4.default.createElement("div", { className: "hse-chip-list" }, (criterion.evidence_refs ?? []).map((ref) => /* @__PURE__ */ import_react4.default.createElement("button", { key: ref, type: "button", "data-highlight": String(focused.evidenceRef === ref && focused.criterion === criterion.id), onClick: () => void ask(selected, { criterion: criterion.id, evidenceRef: ref }, t("suggestedQuestion3")) }, t("evidence"), " \xB7 ", short(ref)))), /* @__PURE__ */ import_react4.default.createElement("dl", null, /* @__PURE__ */ import_react4.default.createElement("dt", null, t("assessmentReason")), /* @__PURE__ */ import_react4.default.createElement("dd", null, criterion.reason || t("noAssessmentReason")), /* @__PURE__ */ import_react4.default.createElement("dt", null, t("assessmentRecommendation")), /* @__PURE__ */ import_react4.default.createElement("dd", { className: "hse-report-recommendation" }, criterion.recommendation || t("noAssessmentRecommendation")))))), /* @__PURE__ */ import_react4.default.createElement(ArtifactPreview, { detail, t }))) : null);
}
function ReporterPanel({ job, workspace, active, artifacts, jobKind, interaction, t }) {
  ...
  return /* @__PURE__ */ import_react4.default.createElement(import_react4.default.Fragment, null, /* @__PURE__ */ import_react4.default.createElement("section", { className: "hse-section" }, /* @__PURE__ */ import_react4.default.createElement("h3", null, t("populationEvidence")), configured ? /* @__PURE__ */ import_react4.default.createElement("div", { className: "hse-hook-state", "data-executed": Boolean(configured.executed) }, /* @__PURE__ */ import_react4.default.createElement("b", null, t("hookExecution"), ": ", configured.id ?? "\u2014", " \xB7 ", configured.version ?? "\u2014"), /* @__PURE__ */ import_react4.default.createElement("br", null), configured.executed ? t("configuredHookRun") : t("configuredHookNotRun")) : null, /* @__PURE__ */ import_react4.default.createElement("div", { className: "hse-kpis" }, /* @__PURE__ */ import_react4.default.createElement("div", { className: "hse-kpi" }, /* @__PURE__ */ import_react4.default.createElement("span", null, t("trials")), /* @__PURE__ */ import_react4.default.createElement("b", null, total)), /* @__PURE__ */ import_react4.default.createElement("div", { className: "hse-kpi" }, /* @__PURE__ */ import_react4.default.createElement("span", null, historical ? t("scoredTrials") : t("valid")), /* @__PURE__ */ import_react4.default.createElement("b", { className: "hse-valid" }, valid ?? "\u2014")), historical ? /* @__PURE__ */ import_react4.default.createElement("div", { className: "hse-kpi" }, /* @__PURE__ */ import_react4.default.createElement("span", null, t("unscoredTrials")), /* @__PURE__ */ import_react4.default.createElement("b", null, unscored)) : /* @__PURE__ */ import_react4.default.createElement("div", { className: "hse-kpi" }, /* @__PURE__ */ import_react4.default.createElement("span", null, t("invalid")), /* @__PURE__ */ import_react4.default.createElement("b", { className: "hse-invalid" }, summary.n_invalid_scores ?? population.invalid_population_size ?? "\u2014")), /* @__PURE__ */ import_react4.default.createElement("div", { className: "hse-kpi" }, /* @__PURE__ */ import_react4.default.createElement("span", null, t("exceptions")), /* @__PURE__ */ import_react4.default.createElement("b", null, summary.n_exceptions ?? 0)), /* @__PURE__ */ import_react4.default.createElement("div", { className: "hse-kpi" }, /* @__PURE__ */ import_react4.default.createElement("span", null, t("coverage")), /* @__PURE__ */ import_react4.default.createElement("b", null, historical && typeof coverage.trial_rate === "number" ? `${format2(coverage.trial_rate * 100)}%` : summary.artifact_validation?.valid ? "VALID" : "CHECK")))), /* @__PURE__ */ import_react4.default.createElement("section", { className: "hse-section" }, /* @__PURE__ */ import_react4.default.createElement("div", { className: "hse-table-wrap" }, /* @__PURE__ */ import_react4.default.createElement("table", { className: "hse-evidence-table" }, /* @__PURE__ */ import_react4.default.createElement("thead", null, /* @__PURE__ */ import_react4.default.createElement("tr", null, /* @__PURE__ */ import_react4.default.createElement("th", null, t("metric")), /* @__PURE__ */ import_react4.default.createElement("th", null, t("aggregate")), /* @__PURE__ */ import_react4.default.createElement("th", null, t("coverage")))), /* @__PURE__ */ import_react4.default.createElement("tbody", null, Object.entries(metrics).map(([id, value]) => /* @__PURE__ */ import_react4.default.createElement("tr", { key: id }, /* @__PURE__ */ import_react4.default.createElement("td", null, /* @__PURE__ */ import_react4.default.createElement("b", null, labels[id] ?? id), /* @__PURE__ */ import_react4.default.createElement("br", null), /* @__PURE__ */ import_react4.default.createElement("code", null, id)), /* @__PURE__ */ import_react4.default.createElement("td", null, format2(value)), /* @__PURE__ */ import_react4.default.createElement("td", null, valid ?? "\u2014", " / ", total))))))), /* @__PURE__ */ import_react4.default.createElement("section", { className: "hse-section" }, /* @__PURE__ */ import_react4.default.createElement("h3", null, t("trialGroups")), /* @__PURE__ */ import_react4.default.createElement("div", { className: "hse-chip-list" }, groups.map((group) => /* @__PURE__ */ import_react4.default.createElement("span", { key: group.id }, group.id, ": ", group.count)))), /* @__PURE__ */ import_react4.default.createElement(TrialAssessmentReport, { job, workspace, active, artifacts, historical, ...interaction, t }));
}
function TrialDeltaTable({ title, items }) {
  return /* @__PURE__ */ import_react4.default.createElement("section", { className: "hse-section" }, /* @__PURE__ */ import_react4.default.createElement("h3", null, title, " \xB7 ", items?.length ?? 0), items?.length ? /* @__PURE__ */ import_react4.default.createElement("div", { className: "hse-table-wrap" }, /* @__PURE__ */ import_react4.default.createElement("table", { className: "hse-evidence-table" }, /* @__PURE__ */ import_react4.default.createElement("thead", null, /* @__PURE__ */ import_react4.default.createElement("tr", null, /* @__PURE__ */ import_react4.default.createElement("th", null, "Trial"), /* @__PURE__ */ import_react4.default.createElement("th", null, "Baseline"), /* @__PURE__ */ import_react4.default.createElement("th", null, "Candidate"), /* @__PURE__ */ import_react4.default.createElement("th", null, "Delta"))), /* @__PURE__ */ import_react4.default.createElement("tbody", null, items.map((item) => /* @__PURE__ */ import_react4.default.createElement("tr", { key: item.trial }, /* @__PURE__ */ import_react4.default.createElement("td", null, item.trial), /* @__PURE__ */ import_react4.default.createElement("td", null, format2(item.baseline)), /* @__PURE__ */ import_react4.default.createElement("td", null, format2(item.candidate)), /* @__PURE__ */ import_react4.default.createElement("td", { className: "hse-delta", "data-positive": (item.delta ?? 0) >= 0 }, item.delta >= 0 ? "+" : "", format2(item.delta))))))) : /* @__PURE__ */ import_react4.default.createElement("span", { className: "hse-muted" }, "0"));
}
function TrialIssueTable({ title, items }) {
  return /* @__PURE__ */ import_react4.default.createElement("section", { className: "hse-section" }, /* @__PURE__ */ import_react4.default.createElement("h3", null, title, " \xB7 ", items?.length ?? 0), items?.length ? /* @__PURE__ */ import_react4.default.createElement("div", { className: "hse-table-wrap" }, /* @__PURE__ */ import_react4.default.createElement("table", { className: "hse-evidence-table" }, /* @__PURE__ */ import_react4.default.createElement("thead", null, /* @__PURE__ */ import_react4.default.createElement("tr", null, /* @__PURE__ */ import_react4.default.createElement("th", null, "Trial"), /* @__PURE__ */ import_react4.default.createElement("th", null, "Baseline"), /* @__PURE__ */ import_react4.default.createElement("th", null, "Candidate"), /* @__PURE__ */ import_react4.default.createElement("th", null, "Reason"))), /* @__PURE__ */ import_react4.default.createElement("tbody", null, items.map((item) => /* @__PURE__ */ import_react4.default.createElement("tr", { key: item.trial }, /* @__PURE__ */ import_react4.default.createElement("td", null, item.trial), /* @__PURE__ */ import_react4.default.createElement("td", null, item.baselineStatus ?? (item.baselineValid === true ? "valid" : item.baselineValid === false ? "invalid" : "\u2014")), /* @__PURE__ */ import_react4.default.createElement("td", null, item.candidateStatus ?? (item.candidateValid === true ? "valid" : item.candidateValid === false ? "invalid" : "\u2014")), /* @__PURE__ */ import_react4.default.createElement("td", null, item.invalidReasons?.join(" \xB7 ") || item.exception?.message || item.exception?.code || "\u2014")))))) : /* @__PURE__ */ import_react4.default.createElement("span", { className: "hse-muted" }, "0"));
}
...
function ComparePanel({ job, workspace, jobs, artifacts, gate, navigation, restoreView, onViewStateChange, contextFor, setContext, askContext, t }) {
  ...
  const [baseline, setBaseline] = (0, import_react4.useState)(() => candidates.some((item) => item.name === restoreView?.compareBaseline) ? restoreView.compareBaseline : candidates[0]?.name ?? "");
  const handledRestore = (0, import_react4.useRef)();
  ...
  const compareContext = (0, import_react4.useMemo)(() => comparison ? contextFor({ comparison, gate: void 0 }) : void 0, [comparison, contextFor]);
  ...
  const labels = metricLabelMap(artifacts);
  return /* @__PURE__ */ import_react4.default.createElement(import_react4.default.Fragment, null, /* @__PURE__ */ import_react4.default.createElement("section", { className: "hse-section" }, /* @__PURE__ */ import_react4.default.createElement("div", { className: "hse-gate-head" }, /* @__PURE__ */ import_react4.default.createElement("h3", null, t("compare")), /* @__PURE__ */ import_react4.default.createElement("button", { type: "button", className: "hse-inline-ask", disabled: !compareContext, onClick: () => compareContext && void askContext(compareContext, t("suggestedQuestion4")) }, t("askAi"))), /* @__PURE__ */ import_react4.default.createElement("div", { className: "hse-compare-select" }, /* @__PURE__ */ import_react4.default.createElement("select", { className: "hse-select", value: effectiveBaseline, onChange: (event) => setBaseline(event.target.value) }, /* @__PURE__ */ import_react4.default.createElement("option", { value: "" }, t("baseline")), candidates.map((item) => /* @__PURE__ */ import_react4.default.createElement("option", { key: item.name, value: item.name }, item.name)))), currentState?.error ? /* @__PURE__ */ import_react4.default.createElement(HarborErrorState, { error: currentState.error, retry: () => setRetry((value) => value + 1), t }) : comparison ? /* @__PURE__ */ import_react4.default.createElement(import_react4.default.Fragment, null, /* @__PURE__ */ import_react4.default.createElement("div", { className: comparison.comparable ? "hse-valid" : "hse-invalid" }, comparison.comparable ? `\u2713 ${t("comparable")}` : `\xD7 ${t("notComparable")}`), /* @__PURE__ */ import_react4.default.createElement("p", { className: "hse-muted" }, comparison.note), /* @__PURE__ */ import_react4.default.createElement("div", { className: "hse-grid" }, Object.entries(comparison.metrics ?? {}).map(([metric, values]) => /* @__PURE__ */ import_react4.default.createElement("div", { className: "hse-card", key: metric }, /* @__PURE__ */ import_react4.default.createElement("span", null, labels[metric] ?? metric, " \xB7 ", values.direction), /* @__PURE__ */ import_react4.default.createElement("b", null, format2(values.baseline), " \u2192 ", format2(values.candidate)), /* @__PURE__ */ import_react4.default.createElement("code", { className: "hse-delta", "data-positive": (values.improvement ?? values.delta ?? 0) >= 0 }, typeof values.delta === "number" ? `${values.delta >= 0 ? "+" : ""}${format2(values.delta)}` : "\u2014"))))) : /* @__PURE__ */ import_react4.default.createElement("span", { className: "hse-muted" }, currentState?.status === "loading" ? t("loading") : t("noData"))), comparison ? /* @__PURE__ */ import_react4.default.createElement(import_react4.default.Fragment, null, /* @__PURE__ */ import_react4.default.createElement(TrialDeltaTable, { title: t("improved"), items: comparison.improvedTrials }), /* @__PURE__ */ import_react4.default.createElement(TrialDeltaTable, { title: t("regressed"), items: comparison.regressedTrials }), /* @__PURE__ */ import_react4.default.createElement(TrialIssueTable, { title: t("invalidTrials"), items: comparison.invalidTrials }), /* @__PURE__ */ import_react4.default.createElement(TrialIssueTable, { title: t("newInfrastructureExceptions"), items: comparison.newInfrastructureExceptions })) : null, /* @__PURE__ */ import_react4.default.createElement("div", { className: "hse-capability" }, t("explicitGate")));
}
function LocalObjectActions({ object, contextFor, setContext, askContext, prompt, navigation, t }) {
  ...
  return /* @__PURE__ */ import_react4.default.createElement("div", { ref: root, className: "hse-local-actions", "data-highlight": String(selected) }, /* @__PURE__ */ import_react4.default.createElement("button", { type: "button", onClick: () => setContext?.(context()) }, t("selectObject")), /* @__PURE__ */ import_react4.default.createElement("button", { type: "button", className: "hse-inline-ask", onClick: () => void askContext(context(), prompt) }, t("askAboutThis")), /* @__PURE__ */ import_react4.default.createElement("code", null, short(object.sourceDigest)));
}
function OptimizerPanel({ artifacts, interactionObjects = [], contextFor, setContext, askContext, navigation, t }) {
  ...
  return /* @__PURE__ */ import_react4.default.createElement(import_react4.default.Fragment, null, /* @__PURE__ */ import_react4.default.createElement("section", { className: "hse-section" }, /* @__PURE__ */ import_react4.default.createElement("h3", null, t("controlledHypotheses")), configured ? /* @__PURE__ */ import_react4.default.createElement("div", { className: "hse-hook-state", "data-executed": Boolean(configured.executed) }, /* @__PURE__ */ import_react4.default.createElement("b", null, t("hookExecution"), ": ", configured.id ?? "\u2014", " \xB7 ", configured.version ?? "\u2014"), /* @__PURE__ */ import_react4.default.createElement("br", null), configured.executed ? t("configuredHookRun") : t("configuredHookNotRun")) : null, /* @__PURE__ */ import_react4.default.createElement("div", { className: "hse-grid" }, /* @__PURE__ */ import_react4.default.createElement("div", { className: "hse-card" }, /* @__PURE__ */ import_react4.default.createElement("span", null, "Diagnoser"), /* @__PURE__ */ import_react4.default.createElement("b", null, diagnosis.hook?.id ?? "\u2014", " \xB7 ", diagnosis.hook?.version ?? "\u2014"), /* @__PURE__ */ import_react4.default.createElement("code", null, diagnoses.length, " diagnoses \xB7 non-reward-affecting")), /* @__PURE__ */ import_react4.default.createElement("div", { className: "hse-card" }, /* @__PURE__ */ import_react4.default.createElement("span", null, t("pluginFallback")), /* @__PURE__ */ import_react4.default.createElement("b", null, optimization.hook?.id ?? "\u2014", " \xB7 ", optimization.hook?.version ?? "\u2014"), /* @__PURE__ */ import_react4.default.createElement("code", null, hypotheses.length, " hypotheses \xB7 non-reward-affecting")))), diagnoses.length ? /* @__PURE__ */ import_react4.default.createElement("section", { className: "hse-section" }, /* @__PURE__ */ import_react4.default.createElement("h3", null, "Diagnoses"), /* @__PURE__ */ import_react4.default.createElement("div", { className: "hse-findings" }, diagnoses.map((item, index) => /* @__PURE__ */ import_react4.default.createElement("div", { className: "hse-finding", key: item.id ?? index }, item.message ?? item.root_cause ?? pretty2(item))))) : null, /* @__PURE__ */ import_react4.default.createElement("section", { className: "hse-section" }, /* @__PURE__ */ import_react4.default.createElement("div", { className: "hse-hypotheses" }, hypotheses.length ? hypotheses.map((item, index) => /* @__PURE__ */ import_react4.default.createElement("article", { className: "hse-hypothesis", key: item.id }, /* @__PURE__ */ import_react4.default.createElement("h4", null, item.id), /* @__PURE__ */ import_react4.default.createElement(LocalObjectActions, { object: interactionObjects.filter((ref) => ref.kind === "hypothesis")[index], contextFor, setContext, askContext, prompt: t("askHypothesis"), navigation, t }), /* @__PURE__ */ import_react4.default.createElement("dl", null, /* @__PURE__ */ import_react4.default.createElement("dt", null, t("rootCause")), /* @__PURE__ */ import_react4.default.createElement("dd", null, item.root_cause ?? "\u2014"), /* @__PURE__ */ import_react4.default.createElement("dt", null, t("affectedTrials")), /* @__PURE__ */ import_react4.default.createElement("dd", null, item.affected_trials?.length ?? 0), /* @__PURE__ */ import_react4.default.createElement("dt", null, t("expectedEffect")), /* @__PURE__ */ import_react4.default.createElement("dd", null, item.expected_metric_effect ?? "\u2014"), /* @__PURE__ */ import_react4.default.createElement("dt", null, t("mutationSurface")), /* @__PURE__ */ import_react4.default.createElement("dd", null, Array.isArray(item.mutation_surface) ? item.mutation_surface.join(" \xB7 ") : item.mutation_surface || "\u2014"), /* @__PURE__ */ import_react4.default.createElement("dt", null, t("forbiddenSurface")), /* @__PURE__ */ import_react4.default.createElement("dd", null, Array.isArray(item.forbidden_surface) ? item.forbidden_surface.join(" \xB7 ") : item.forbidden_surface || "\u2014"), /* @__PURE__ */ import_react4.default.createElement("dt", null, t("guardrails")), /* @__PURE__ */ import_react4.default.createElement("dd", null, Array.isArray(item.guardrails) ? item.guardrails.join(" \xB7 ") : item.guardrails || "\u2014"), /* @__PURE__ */ import_react4.default.createElement("dt", null, t("rollback")), /* @__PURE__ */ import_react4.default.createElement("dd", null, item.rollback_condition ?? "\u2014"), /* @__PURE__ */ import_react4.default.createElement("dt", null, t("nextExperiment")), /* @__PURE__ */ import_react4.default.createElement("dd", null, item.next_experiment ?? "\u2014")), /* @__PURE__ */ import_react4.default.createElement("details", { className: "hse-source-details" }, /* @__PURE__ */ import_react4.default.createElement("summary", null, t("provenance"), " \xB7 ", item.evidence_refs?.length ?? 0), /* @__PURE__ */ import_react4.default.createElement("pre", { className: "hse-source" }, pretty2(item.evidence_refs))))) : /* @__PURE__ */ import_react4.default.createElement("div", { className: "hse-empty" }, t("noHypotheses")))));
}
function GateEvidencePanel({ artifacts, interactionObjects = [], contextFor, setContext, askContext, navigation, t }) {
  ...
  if (!report) return /* @__PURE__ */ import_react4.default.createElement("section", { className: "hse-section" }, /* @__PURE__ */ import_react4.default.createElement("h3", null, t("gateEvidence")), /* @__PURE__ */ import_react4.default.createElement("span", { className: "hse-muted" }, t("noData")));
  const labels = metricLabelMap(artifacts);
  const pass = report.decision === "PROMOTE";
  const population = report.population ?? {};
  return /* @__PURE__ */ import_react4.default.createElement(import_react4.default.Fragment, null, /* @__PURE__ */ import_react4.default.createElement("section", { className: "hse-section" }, /* @__PURE__ */ import_react4.default.createElement("div", { className: "hse-gate-head" }, /* @__PURE__ */ import_react4.default.createElement("div", null, /* @__PURE__ */ import_react4.default.createElement("h3", null, t("gateEvidence")), /* @__PURE__ */ import_react4.default.createElement("p", { className: "hse-muted" }, report.baseline_job ?? "\u2014", " \u2192 ", report.candidate_job ?? "\u2014")), /* @__PURE__ */ import_react4.default.createElement("span", { className: "hse-decision", "data-pass": pass }, report.decision ?? "\u2014")), /* @__PURE__ */ import_react4.default.createElement("div", { className: "hse-grid" }, /* @__PURE__ */ import_react4.default.createElement("div", { className: "hse-card" }, /* @__PURE__ */ import_react4.default.createElement("span", null, t("comparable")), /* @__PURE__ */ import_react4.default.createElement("b", { className: report.comparable ? "hse-valid" : "hse-invalid" }, report.comparable ? "\u2713 TRUE" : "\xD7 FALSE"), /* @__PURE__ */ import_react4.default.createElement("code", null, short(report.baseline_evaluation_context?.digest), " = ", short(report.candidate_evaluation_context?.digest))), /* @__PURE__ */ import_react4.default.createElement("div", { className: "hse-card" }, /* @__PURE__ */ import_react4.default.createElement("span", null, report.gate_eligible ? t("eligible") : t("notEligible")), /* @__PURE__ */ import_react4.default.createElement("b", { className: report.gate_eligible ? "hse-valid" : "hse-invalid" }, population.baseline_valid ?? "\u2014", " / ", population.baseline ?? "\u2014", " \u2192 ", population.candidate_valid ?? "\u2014", " / ", population.candidate ?? "\u2014"), /* @__PURE__ */ import_react4.default.createElement("code", null, t("policy"), ": ", report.policy?.policy_id ?? "\u2014", " \xB7 ", report.policy?.version ?? "\u2014")))), /* @__PURE__ */ import_react4.default.createElement("section", { className: "hse-section" }, /* @__PURE__ */ import_react4.default.createElement("h3", null, t("metricDeltas")), /* @__PURE__ */ import_react4.default.createElement("div", { className: "hse-table-wrap" }, /* @__PURE__ */ import_react4.default.createElement("table", { className: "hse-evidence-table" }, /* @__PURE__ */ import_react4.default.createElement("thead", null, /* @__PURE__ */ import_react4.default.createElement("tr", null, /* @__PURE__ */ import_react4.default.createElement("th", null, t("metric")), /* @__PURE__ */ import_react4.default.createElement("th", null, "Baseline"), /* @__PURE__ */ import_react4.default.createElement("th", null, "Candidate"), /* @__PURE__ */ import_react4.default.createElement("th", null, "Delta"))), /* @__PURE__ */ import_react4.default.createElement("tbody", null, Object.entries(report.metric_deltas ?? {}).map(([id, delta]) => /* @__PURE__ */ import_react4.default.createElement("tr", { key: id }, /* @__PURE__ */ import_react4.default.createElement("td", null, labels[id] ?? id), /* @__PURE__ */ import_react4.default.createElement("td", null, format2(report.baseline_metrics?.[id])), /* @__PURE__ */ import_react4.default.createElement("td", null, format2(report.candidate_metrics?.[id])), /* @__PURE__ */ import_react4.default.createElement("td", { className: "hse-delta", "data-positive": delta >= 0 }, delta >= 0 ? "+" : "", format2(delta)))))))), /* @__PURE__ */ import_react4.default.createElement("section", { className: "hse-section" }, /* @__PURE__ */ import_react4.default.createElement("div", { className: "hse-kpis" }, /* @__PURE__ */ import_react4.default.createElement("div", { className: "hse-kpi" }, /* @__PURE__ */ import_react4.default.createElement("span", null, t("improved")), /* @__PURE__ */ import_react4.default.createElement("b", null, report.improved_trials?.length ?? 0)), /* @__PURE__ */ import_react4.default.createElement("div", { className: "hse-kpi" }, /* @__PURE__ */ import_react4.default.createElement("span", null, t("regressed")), /* @__PURE__ */ import_react4.default.createElement("b", null, report.regressed_trials?.length ?? 0)), /* @__PURE__ */ import_react4.default.createElement("div", { className: "hse-kpi" }, /* @__PURE__ */ import_react4.default.createElement("span", null, t("newExceptions")), /* @__PURE__ */ import_react4.default.createElement("b", null, report.new_exceptions?.length ?? 0)), /* @__PURE__ */ import_react4.default.createElement("div", { className: "hse-kpi" }, /* @__PURE__ */ import_react4.default.createElement("span", null, t("artifactRegressions")), /* @__PURE__ */ import_react4.default.createElement("b", null, report.artifact_regressions?.length ?? 0)), /* @__PURE__ */ import_react4.default.createElement("div", { className: "hse-kpi" }, /* @__PURE__ */ import_react4.default.createElement("span", null, t("reasons")), /* @__PURE__ */ import_react4.default.createElement("b", null, report.reasons?.length ?? 0))), report.reasons?.length ? /* @__PURE__ */ import_react4.default.createElement("ul", null, report.reasons.map((reason, index) => /* @__PURE__ */ import_react4.default.createElement("li", { key: `${gateReasonText(reason)}-${index}` }, gateReasonText(reason), /* @__PURE__ */ import_react4.default.createElement(LocalObjectActions, { object: interactionObjects.filter((ref) => ref.kind === "gate-reason")[index], contextFor, setContext, askContext, prompt: t("askGateReason"), navigation, t })))) : null));
}
function HistoricalGatePanel({ t }) {
  return /* @__PURE__ */ import_react4.default.createElement("section", { className: "hse-section" }, /* @__PURE__ */ import_react4.default.createElement("div", { className: "hse-gate-head" }, /* @__PURE__ */ import_react4.default.createElement("div", null, /* @__PURE__ */ import_react4.default.createElement("h3", null, t("gateEvidence")), /* @__PURE__ */ import_react4.default.createElement("p", { className: "hse-muted" }, t("gateNotApplicableHint"))), /* @__PURE__ */ import_react4.default.createElement("span", { className: "hse-decision" }, t("gateNotApplicable"))), /* @__PURE__ */ import_react4.default.createElement("div", { className: "hse-capability" }, /* @__PURE__ */ import_react4.default.createElement("b", null, "UNSUPPORTED_JOB_KIND_FOR_PROMOTION"), /* @__PURE__ */ import_react4.default.createElement("br", null), "historical-generation-evaluation \xB7 diagnostic \xB7 observe-existing"));
}
...
function EvaluatorEditor(props) {
  const update = useHarborMutation();
  const sessionId = (0, import_react4.useContext)(HarborSessionContext);
  return /* @__PURE__ */ import_react4.default.createElement(EvaluatorEditorView, { ...props, sessionId: String(sessionId), update, ErrorState: HarborErrorState, applySourceProposal, nextVersion });
}
...
function SavedSourceFragment({ component, object, contextFor, setContext, askContext, navigation, t }) {
  ...
  const [range, setRange] = (0, import_react4.useState)({ startLine: 1, endLine: Math.min(String(source ?? "").split("\n").length, 200) });
  const input = (0, import_react4.useRef)();
  (0, import_react4.useEffect)(() => {
  ...
  return /* @__PURE__ */ import_react4.default.createElement("section", { className: "hse-section hse-saved-source" }, /* @__PURE__ */ import_react4.default.createElement("h3", null, component.id, " \xB7 ", t("sourceSelection")), /* @__PURE__ */ import_react4.default.createElement("p", { className: "hse-muted" }, t("sourceSaved")), /* @__PURE__ */ import_react4.default.createElement("textarea", { ref: input, className: "hse-editor", readOnly: true, value: source, "aria-label": `${t("sourceSelection")} ${object.sourceRole}`, onSelect: select }), /* @__PURE__ */ import_react4.default.createElement("div", { className: "hse-local-actions" }, /* @__PURE__ */ import_react4.default.createElement("span", null, "L", range.startLine, "\u2013", range.endLine), /* @__PURE__ */ import_react4.default.createElement("button", { type: "button", className: "hse-inline-ask", onClick: () => void askContext(context(range), t("askSource")) }, t("askSourceLabel")), /* @__PURE__ */ import_react4.default.createElement("button", { type: "button", className: "hse-inline-ask", onClick: () => void askContext(context(range), t("askSourceChange")) }, t("askSourceChangeLabel"))));
}
function GovernancePanel({ job, workspace, contextFor, setContext, askContext, navigation, proposal, t }) {
  ...
  const activeGovernanceKey = (0, import_react4.useRef)(requestKey);
  activeGovernanceKey.current = requestKey;
  const requestSequence = (0, import_react4.useRef)(0);
  const [state, setState] = (0, import_react4.useState)({ requestKey, status: "loading" });
  const [copied, setCopied] = (0, import_react4.useState)(false);
  const [saveReceipt, setSaveReceipt] = (0, import_react4.useState)();
  ...
  const bindingIsCurrent = (0, import_react4.useCallback)((loadedKey) => ownsGovernanceBinding(activeGovernanceKey.current, loadedKey), []);
  const receipt = saveReceipt?.requestKey === requestKey ? /* @__PURE__ */ import_react4.default.createElement(SavedEvaluatorNextSteps, { receipt: saveReceipt.value, historicalJob: job, onPreparePlan: (prompt2) => askContext(contextFor({}), prompt2), t }) : null;
  const currentState = state.requestKey === requestKey ? state : { requestKey, status: "loading" };
  if (currentState.status === "loading") return /* @__PURE__ */ import_react4.default.createElement(import_react4.default.Fragment, null, receipt, /* @__PURE__ */ import_react4.default.createElement(HarborSkeleton, { kind: "governance", rows: 6, label: t("loading") }));
  if (currentState.status === "error") return /* @__PURE__ */ import_react4.default.createElement(import_react4.default.Fragment, null, receipt, /* @__PURE__ */ import_react4.default.createElement(HarborErrorState, { error: currentState.error, retry: () => void load(), t }));
  ...
  return /* @__PURE__ */ import_react4.default.createElement(import_react4.default.Fragment, null, receipt, /* @__PURE__ */ import_react4.default.createElement("section", { className: "hse-section" }, /* @__PURE__ */ import_react4.default.createElement("h3", null, t("currentEvaluator")), /* @__PURE__ */ import_react4.default.createElement("p", { className: "hse-muted" }, t("governanceHint")), /* @__PURE__ */ import_react4.default.createElement("div", { className: "hse-governance-id" }, /* @__PURE__ */ import_react4.default.createElement("div", { className: "hse-card" }, /* @__PURE__ */ import_react4.default.createElement("span", null, t("evaluator")), /* @__PURE__ */ import_react4.default.createElement("b", null, evaluator?.id ?? "\u2014", " \xB7 ", evaluator?.version ?? "\u2014"), /* @__PURE__ */ import_react4.default.createElement("code", null, evaluator?.entry ?? "\u2014")), /* @__PURE__ */ import_react4.default.createElement("div", { className: "hse-card" }, /* @__PURE__ */ import_react4.default.createElement("span", null, t("rubric")), /* @__PURE__ */ import_react4.default.createElement("b", null, rubric?.id ?? "\u2014", " \xB7 ", rubric?.version ?? "\u2014"), /* @__PURE__ */ import_react4.default.createElement("code", null, rubric?.entry ?? "\u2014")), /* @__PURE__ */ import_react4.default.createElement("div", { className: "hse-card" }, /* @__PURE__ */ import_react4.default.createElement("span", null, "Judge"), /* @__PURE__ */ import_react4.default.createElement("b", null, value.judge?.provider ?? "\u2014", " / ", value.judge?.model ?? "\u2014"), /* @__PURE__ */ import_react4.default.createElement("code", null, judgeIdentityDetails(value.judge))))), /* @__PURE__ */ import_react4.default.createElement(EvaluatorEditor, { proposal, job, value, workspace, bindingKey: currentState.requestKey, bindingIsCurrent, reload: load, onSaved: (value2) => setSaveReceipt({ requestKey, value: value2 }), t }), ["evaluator", "rubric"].map((role) => /* @__PURE__ */ import_react4.default.createElement(SavedSourceFragment, { key: role, component: value.components?.[role], object: value.interactionObjects?.find((ref) => ref.sourceRole === role), contextFor, setContext, askContext, navigation, t })), [["evaluator", evaluator], ["rubric", rubric]].map(([role, component]) => /* @__PURE__ */ import_react4.default.createElement("section", { className: "hse-section", key: role }, /* @__PURE__ */ import_react4.default.createElement("h3", null, role === "evaluator" ? t("evaluator") : t("rubric"), " \xB7 ", component?.id ?? "\u2014", " \xB7 ", component?.version ?? "\u2014"), /* @__PURE__ */ import_react4.default.createElement("div", { className: "hse-grid" }, /* @__PURE__ */ import_react4.default.createElement("div", { className: "hse-card" }, /* @__PURE__ */ import_react4.default.createElement("span", null, t("sourceCode")), /* @__PURE__ */ import_react4.default.createElement("b", null, component?.entry ?? "\u2014"), /* @__PURE__ */ import_react4.default.createElement("code", null, short(component?.digest))), /* @__PURE__ */ import_react4.default.createElement("div", { className: "hse-card" }, /* @__PURE__ */ import_react4.default.createElement("span", null, "Reward semantics"), /* @__PURE__ */ import_react4.default.createElement("b", null, component?.reward_affecting ? "reward-affecting" : "non-reward"), /* @__PURE__ */ import_react4.default.createElement("code", null, component?.source?.error ?? "read-only"))), component?.source?.text ? /* @__PURE__ */ import_react4.default.createElement("details", { className: "hse-source-details" }, /* @__PURE__ */ import_react4.default.createElement("summary", null, t("sourceCode")), /* @__PURE__ */ import_react4.default.createElement("pre", { className: "hse-source" }, component.source.text)) : /* @__PURE__ */ import_react4.default.createElement("div", { className: "hse-capability" }, component?.source?.error))), /* @__PURE__ */ import_react4.default.createElement("section", { className: "hse-section hse-upgrade" }, /* @__PURE__ */ import_react4.default.createElement("h3", null, t("upgradeEvaluator")), /* @__PURE__ */ import_react4.default.createElement("p", { className: "hse-muted" }, t("upgradeHint")), /* @__PURE__ */ import_react4.default.createElement("ol", null, [1, 2, 3, 4, 5].map((index) => /* @__PURE__ */ import_react4.default.createElement("li", { key: index }, t(`upgradeStep${index}`)))), /* @__PURE__ */ import_react4.default.createElement("div", { className: "hse-grid" }, /* @__PURE__ */ import_react4.default.createElement("div", { className: "hse-card" }, /* @__PURE__ */ import_react4.default.createElement("span", null, t("freshBaseline")), /* @__PURE__ */ import_react4.default.createElement("b", null, "Evaluator / Rubric / Judge identity"), /* @__PURE__ */ import_react4.default.createElement("code", null, (workflow.freshBaselineRequiredWhen ?? []).join(" \xB7 "))), /* @__PURE__ */ import_react4.default.createElement("div", { className: "hse-card" }, /* @__PURE__ */ import_react4.default.createElement("span", null, t("metaEvaluation")), /* @__PURE__ */ import_react4.default.createElement("b", null, "Independent GT \xB7 ESF \xB7 SCE \xB7 RCR"), /* @__PURE__ */ import_react4.default.createElement("code", null, "No automatic evaluation or Gate"))), /* @__PURE__ */ import_react4.default.createElement("pre", { className: "hse-prompt" }, prompt), /* @__PURE__ */ import_react4.default.createElement("div", { className: "hse-prompt-actions" }, /* @__PURE__ */ import_react4.default.createElement("button", { className: "hse-button", type: "button", onClick: () => void copy2() }, copied ? t("copied") : t("copyPrompt")))));
}
function MetaEvaluationPanel({ job, workspace, t }) {
  ...
  const currentState = state.requestKey === requestKey ? state : { requestKey, status: "loading" };
  if (currentState.status === "loading" && !currentState.value) return /* @__PURE__ */ import_react4.default.createElement(HarborSkeleton, { kind: "meta", rows: 7, label: t("loading") });
  if (currentState.status === "error" && !currentState.value) return /* @__PURE__ */ import_react4.default.createElement(HarborErrorState, { error: currentState.error, retry: () => setRetry((value2) => value2 + 1), t });
  const value = currentState.value ?? {};
  ...
  return /* @__PURE__ */ import_react4.default.createElement(import_react4.default.Fragment, null, currentState.error ? /* @__PURE__ */ import_react4.default.createElement(HarborErrorState, { error: currentState.error, retry: () => setRetry((value2) => value2 + 1), t }) : null, /* @__PURE__ */ import_react4.default.createElement("section", { className: "hse-section" }, /* @__PURE__ */ import_react4.default.createElement("h3", null, t("metaWorkflow")), /* @__PURE__ */ import_react4.default.createElement("p", { className: "hse-muted" }, t("metaWorkflowHint")), /* @__PURE__ */ import_react4.default.createElement("div", { className: "hse-meta-flow" }, /* @__PURE__ */ import_react4.default.createElement("div", null, /* @__PURE__ */ import_react4.default.createElement("b", null, "1. Evaluator Candidate"), /* @__PURE__ */ import_react4.default.createElement("br", null), value.workflow?.candidate), /* @__PURE__ */ import_react4.default.createElement("div", null, /* @__PURE__ */ import_react4.default.createElement("b", null, "2. Fixed artifacts + GT"), /* @__PURE__ */ import_react4.default.createElement("br", null), value.workflow?.dataset), /* @__PURE__ */ import_react4.default.createElement("div", null, /* @__PURE__ */ import_react4.default.createElement("b", null, "3. Repeated observations"), /* @__PURE__ */ import_react4.default.createElement("br", null), value.workflow?.output), /* @__PURE__ */ import_react4.default.createElement("div", null, /* @__PURE__ */ import_react4.default.createElement("b", null, "4. ESF / SCE / RCR"), /* @__PURE__ */ import_react4.default.createElement("br", null), value.workflow?.verifier))), /* @__PURE__ */ import_react4.default.createElement("section", { className: "hse-section" }, /* @__PURE__ */ import_react4.default.createElement("h3", null, t("groundTruth")), groundTruth ? /* @__PURE__ */ import_react4.default.createElement(import_react4.default.Fragment, null, /* @__PURE__ */ import_react4.default.createElement("div", { className: "hse-grid" }, /* @__PURE__ */ import_react4.default.createElement("div", { className: "hse-card" }, /* @__PURE__ */ import_react4.default.createElement("span", null, "ID / version"), /* @__PURE__ */ import_react4.default.createElement("b", null, groundTruth.id, " \xB7 ", groundTruth.version), /* @__PURE__ */ import_react4.default.createElement("code", null, groundTruth.path)), /* @__PURE__ */ import_react4.default.createElement("div", { className: "hse-card" }, /* @__PURE__ */ import_react4.default.createElement("span", null, t("gtSource")), /* @__PURE__ */ import_react4.default.createElement("b", null, groundTruth.source?.kind), /* @__PURE__ */ import_react4.default.createElement("code", null, groundTruth.source?.description)), /* @__PURE__ */ import_react4.default.createElement("div", { className: "hse-card" }, /* @__PURE__ */ import_react4.default.createElement("span", null, t("gtCases")), /* @__PURE__ */ import_react4.default.createElement("b", null, groundTruth.caseCount), /* @__PURE__ */ import_react4.default.createElement("code", null, groundTruth.criteria?.map((item) => item.label ?? item.id).join(" \xB7 "))), /* @__PURE__ */ import_react4.default.createElement("div", { className: "hse-card" }, /* @__PURE__ */ import_react4.default.createElement("span", null, t("gtBadcases")), /* @__PURE__ */ import_react4.default.createElement("b", null, groundTruth.badcaseCount), /* @__PURE__ */ import_react4.default.createElement("code", null, t("gtProvenance"), ": ", groundTruth.source?.provenance)))) : /* @__PURE__ */ import_react4.default.createElement("div", { className: "hse-capability" }, /* @__PURE__ */ import_react4.default.createElement("b", null, t("groundTruthRequired")), /* @__PURE__ */ import_react4.default.createElement("br", null), t("gtKinds")), /* @__PURE__ */ import_react4.default.createElement("div", { className: "hse-hook-state", "data-executed": Boolean(report) }, /* @__PURE__ */ import_react4.default.createElement("b", null, t("metaNext")), /* @__PURE__ */ import_react4.default.createElement("br", null), value.workflow?.nextAction)), report ? /* @__PURE__ */ import_react4.default.createElement(import_react4.default.Fragment, null, /* @__PURE__ */ import_react4.default.createElement("section", { className: "hse-section" }, /* @__PURE__ */ import_react4.default.createElement("h3", null, "Evaluator \xB7 ", report.evaluator?.id, " \xB7 ", report.evaluator?.version), /* @__PURE__ */ import_react4.default.createElement("div", { className: "hse-kpis" }, /* @__PURE__ */ import_react4.default.createElement("div", { className: "hse-kpi" }, /* @__PURE__ */ import_react4.default.createElement("span", null, "ESF \u2191"), /* @__PURE__ */ import_react4.default.createElement("b", null, format2(metrics.esf))), /* @__PURE__ */ import_react4.default.createElement("div", { className: "hse-kpi" }, /* @__PURE__ */ import_react4.default.createElement("span", null, "SCE \u2193"), /* @__PURE__ */ import_react4.default.createElement("b", null, format2(metrics.sce))), /* @__PURE__ */ import_react4.default.createElement("div", { className: "hse-kpi" }, /* @__PURE__ */ import_react4.default.createElement("span", null, "RCR \u2191"), /* @__PURE__ */ import_react4.default.createElement("b", null, format2(metrics.rcr))), /* @__PURE__ */ import_react4.default.createElement("div", { className: "hse-kpi" }, /* @__PURE__ */ import_react4.default.createElement("span", null, t("coverage")), /* @__PURE__ */ import_react4.default.createElement("b", null, format2(report.coverage?.rate))), /* @__PURE__ */ import_react4.default.createElement("div", { className: "hse-kpi" }, /* @__PURE__ */ import_react4.default.createElement("span", null, t("disagreements")), /* @__PURE__ */ import_react4.default.createElement("b", null, pagination.total ?? report.disagreements?.length ?? 0)))), pagination.total ? /* @__PURE__ */ import_react4.default.createElement("section", { className: "hse-section" }, /* @__PURE__ */ import_react4.default.createElement("h3", null, t("disagreements")), /* @__PURE__ */ import_react4.default.createElement("div", { className: "hse-table-wrap" }, /* @__PURE__ */ import_react4.default.createElement("table", { className: "hse-evidence-table" }, /* @__PURE__ */ import_react4.default.createElement("thead", null, /* @__PURE__ */ import_react4.default.createElement("tr", null, /* @__PURE__ */ import_react4.default.createElement("th", null, "Case"), /* @__PURE__ */ import_react4.default.createElement("th", null, "Criterion"), /* @__PURE__ */ import_react4.default.createElement("th", null, "GT"), /* @__PURE__ */ import_react4.default.createElement("th", null, "Observed"))), /* @__PURE__ */ import_react4.default.createElement("tbody", null, (report.disagreements ?? []).map((item, index) => /* @__PURE__ */ import_react4.default.createElement("tr", { key: `${item.case_id}-${item.repeat}-${item.criterion_id}-${index}` }, /* @__PURE__ */ import_react4.default.createElement("td", null, item.case_id), /* @__PURE__ */ import_react4.default.createElement("td", null, item.criterion_id), /* @__PURE__ */ import_react4.default.createElement("td", null, format2(item.ground_truth)), /* @__PURE__ */ import_react4.default.createElement("td", null, format2(item.observed))))))), /* @__PURE__ */ import_react4.default.createElement("div", { className: "hse-pager" }, /* @__PURE__ */ import_react4.default.createElement("span", null, pagination.total ? `${loadedOffset + 1}\u2013${Math.min(loadedOffset + (report.disagreements?.length ?? 0), pagination.total)} / ${pagination.total}` : "0 / 0"), /* @__PURE__ */ import_react4.default.createElement("button", { disabled: !loadedOffset, onClick: () => setOffset(Math.max(0, loadedOffset - pageSize)) }, t("previous")), /* @__PURE__ */ import_react4.default.createElement("button", { disabled: !pagination.hasMore, onClick: () => setOffset(loadedOffset + pageSize) }, t("next")))) : null) : null);
}
function HistoricalMetaEvaluationPanel({ detail, artifacts, t }) {
  ...
  return /* @__PURE__ */ import_react4.default.createElement("section", { className: "hse-section" }, /* @__PURE__ */ import_react4.default.createElement("h3", null, t("meta")), /* @__PURE__ */ import_react4.default.createElement("p", { className: "hse-muted" }, t("metaNotRunHint")), /* @__PURE__ */ import_react4.default.createElement("div", { className: "hse-grid" }, /* @__PURE__ */ import_react4.default.createElement("div", { className: "hse-card" }, /* @__PURE__ */ import_react4.default.createElement("span", null, t("currentStatus")), /* @__PURE__ */ import_react4.default.createElement("b", null, notRun ? t("metaNotRun") : metaEvaluation.status ?? "\u2014"), /* @__PURE__ */ import_react4.default.createElement("code", null, context.protocol ?? "historical-generation-evaluation-context/v1")), /* @__PURE__ */ import_react4.default.createElement("div", { className: "hse-card" }, /* @__PURE__ */ import_react4.default.createElement("span", null, "Validation report"), /* @__PURE__ */ import_react4.default.createElement("b", null, metaEvaluation.validation_report_ref ?? "\u2014"), /* @__PURE__ */ import_react4.default.createElement("code", null, notRun ? "Evaluator reliability remains unvalidated" : short(metaEvaluation.digest)))));
}
...
function JobIdentityHeader({ context, summary, t }) {
  return /* @__PURE__ */ import_react4.default.createElement("details", { className: "hse-job-identities" }, /* @__PURE__ */ import_react4.default.createElement("summary", null, t("identityDetails"), " \xB7 ", t("progress"), ": ", summary?.progress?.completed ?? 0, "/", summary?.progress?.total ?? summary?.nTrials ?? "\u2014"), /* @__PURE__ */ import_react4.default.createElement("div", { className: "hse-identity-tags" }, ["candidate", "dataset", "context", "stack"].map((role) => {
    const value = context?.identities?.[role];
    return /* @__PURE__ */ import_react4.default.createElement("span", { key: role }, /* @__PURE__ */ import_react4.default.createElement("small", null, role), /* @__PURE__ */ import_react4.default.createElement("b", { title: value?.digest }, value?.id ?? "\u2014", value?.version ? ` @ ${value.version}` : ""), /* @__PURE__ */ import_react4.default.createElement("code", null, short(value?.digest)));
  })), /* @__PURE__ */ import_react4.default.createElement("div", { className: "hse-identity-flags" }, /* @__PURE__ */ import_react4.default.createElement(ContextFlags, { context, t }), /* @__PURE__ */ import_react4.default.createElement("span", null, t("mode"), ": ", summary?.mode ?? "\u2014"), /* @__PURE__ */ import_react4.default.createElement("span", null, t("validity"), ": ", summary?.nValidScores ?? "\u2014", " / ", summary?.nTrials ?? "\u2014")));
}
function JobSummaryPanel({ detail, summary, contextFor, setContext, askContext, navigation, openSection, t }) {
  ...
  return /* @__PURE__ */ import_react4.default.createElement("section", { className: "hse-section hse-job-summary" }, /* @__PURE__ */ import_react4.default.createElement("div", { className: "hse-summary-status" }, /* @__PURE__ */ import_react4.default.createElement("div", null, /* @__PURE__ */ import_react4.default.createElement("h3", null, t("health"), ": ", attention ? t(`health_${attention.kind}`) : t("unavailable")), /* @__PURE__ */ import_react4.default.createElement("p", null, t("askHealth"))), /* @__PURE__ */ import_react4.default.createElement("button", { type: "button", className: "hse-ask", onClick: () => void askContext(contextFor({}), t("askHealth")) }, t("askAi"))), /* @__PURE__ */ import_react4.default.createElement("div", { className: "hse-summary-metrics" }, metrics.length ? metrics.map(([name2, value], index) => /* @__PURE__ */ import_react4.default.createElement("div", { className: "hse-summary-metric", key: name2 }, /* @__PURE__ */ import_react4.default.createElement("span", null, name2), /* @__PURE__ */ import_react4.default.createElement("strong", null, format2(value)), /* @__PURE__ */ import_react4.default.createElement(LocalObjectActions, { object: objects.filter((ref) => ref.kind === "metric")[index], contextFor, setContext, askContext, navigation, prompt: t("askMetric"), t }))) : /* @__PURE__ */ import_react4.default.createElement("p", null, t("noMetric"))), /* @__PURE__ */ import_react4.default.createElement("div", { className: "hse-summary-links" }, ["trials", "optimization", "compare", "evaluator"].map((section) => /* @__PURE__ */ import_react4.default.createElement("button", { type: "button", className: "hse-button", key: section, onClick: () => openSection(section) }, t(`jobSection_${section}`), " \u2192"))));
}
function Workbench({ job, workspace, jobs, close, navigation, consumeNavigation, restoreView, hasHistory, scrollContainerRef, onViewStateChange, sessionId, pageSessionId, bridge, askContext, t }) {
  ...
  const request = useHarborApi();
  const [state, setState] = (0, import_react4.useState)({ status: "loading" });
  const [stage, setStage] = (0, import_react4.useState)(() => STAGES.includes(restoreView?.stage) ? restoreView.stage : "candidate");
  const [section, setSection] = (0, import_react4.useState)(() => JOB_SECTIONS.includes(restoreView?.section) ? restoreView.section : sectionForNavigation(navigation?.target));
  ...
  const childContext = (0, import_react4.useRef)(false);
  const requestSequence = (0, import_react4.useRef)(0);
  const handledRestore = (0, import_react4.useRef)();
  const restoredScroll = (0, import_react4.useRef)();
  const restoreFrames = (0, import_react4.useRef)([]);
  const restoreObserver = (0, import_react4.useRef)();
  const restoreTimer = (0, import_react4.useRef)();
  const activeRestoreId = (0, import_react4.useRef)(restoreView?.restoreId);
  activeRestoreId.current = restoreView?.restoreId;
  const trialViewState = (0, import_react4.useRef)(restoreView?.trialView);
  const compareBaselineState = (0, import_react4.useRef)(restoreView?.compareBaseline);
  const gateRouteState = (0, import_react4.useRef)(
  ...
  const stopRestoredScroll = (0, import_react4.useCallback)(() => {
  ...
  const applyRestoredScroll = (0, import_react4.useCallback)((restoreId) => {
  ...
  (0, import_react4.useEffect)(() => stopRestoredScroll, [stopRestoredScroll]);
  ...
  const contextFor = (0, import_react4.useCallback)((selection) => buildUiContext({
    sessionId,
    pageSessionId,
    workspace,
    job,
  ...
  const publishContext = (0, import_react4.useCallback)((context) => {
    if (!context) return;
  ...
  const jobContext = (0, import_react4.useMemo)(() => contextFor({}), [contextFor]);
  const resetChildContext = (0, import_react4.useCallback)(() => {
  ...
  let content;
  if (section === "summary") content = /* @__PURE__ */ import_react4.default.createElement(JobSummaryPanel, { detail, summary: activeJob, contextFor, setContext: publishContext, askContext, navigation, openSection, t });
  else if (section === "evaluator") content = /* @__PURE__ */ import_react4.default.createElement(GovernancePanel, { job, workspace, contextFor, setContext: publishContext, askContext, navigation, proposal: interaction.evaluatorProposal, t });
  else if (section === "artifacts") content = /* @__PURE__ */ import_react4.default.createElement("section", { className: "hse-section" }, /* @__PURE__ */ import_react4.default.createElement("h3", null, t("artifacts")), /* @__PURE__ */ import_react4.default.createElement(ArtifactPreview, { detail: { preview: artifacts.registry ? { kind: "structured", format: "json", title: t("artifacts"), content: artifacts.registry } : void 0 }, t }), /* @__PURE__ */ import_react4.default.createElement(JsonSection, { title: t("artifacts"), value: artifacts.registry }));
  else if (section === "audit") content = /* @__PURE__ */ import_react4.default.createElement(JsonSection, { title: t("audit"), value: { validation: detail?.validation, context: artifacts.context, doctor: artifacts.doctor, registry: artifacts.registry } });
  else if (stage === "candidate") content = historical ? /* @__PURE__ */ import_react4.default.createElement(HistoricalTargetPanel, { detail, artifacts, t }) : /* @__PURE__ */ import_react4.default.createElement(CandidatePanel, { artifacts, t });
  else if (stage === "dataset") content = /* @__PURE__ */ import_react4.default.createElement(DatasetPanel, { job, workspace, artifacts, t });
  else if (stage === "renderer") content = /* @__PURE__ */ import_react4.default.createElement(RendererPanel, { job, workspace, active: Boolean(activeJob?.progress?.active), component, contextFor, setContext: publishContext, askContext, navigation, t });
  else if (stage === "judge") content = /* @__PURE__ */ import_react4.default.createElement(import_react4.default.Fragment, null, /* @__PURE__ */ import_react4.default.createElement("section", { className: "hse-section" }, /* @__PURE__ */ import_react4.default.createElement("h3", null, t("trials"), " / ", t("evidence")), /* @__PURE__ */ import_react4.default.createElement(TrialExplorer, { job, workspace, active: Boolean(activeJob?.progress?.active), navigation, restoreView, onViewStateChange: (value) => {
  ...
  else if (stage === "meta") content = historical ? /* @__PURE__ */ import_react4.default.createElement(HistoricalMetaEvaluationPanel, { detail, artifacts, t }) : /* @__PURE__ */ import_react4.default.createElement(MetaEvaluationPanel, { job, workspace, t });
  else if (stage === "reporter") content = /* @__PURE__ */ import_react4.default.createElement(ReporterPanel, { job, workspace, active: Boolean(activeJob?.progress?.active), artifacts, jobKind: detail?.jobKind ?? activeJob?.jobKind, interaction: { contextFor, setContext: publishContext, askContext, navigation, restoreView, onViewStateChange: (value) => {
    trialViewState.current = value;
    onViewStateChange?.({ stage, section, trialView: value });
  } }, t });
  else if (stage === "optimizer") content = /* @__PURE__ */ import_react4.default.createElement(OptimizerPanel, { artifacts, interactionObjects: detail?.interactionObjects, contextFor, setContext: publishContext, askContext, navigation, t });
  else if (stage === "gate") content = historical ? /* @__PURE__ */ import_react4.default.createElement(HistoricalGatePanel, { t }) : /* @__PURE__ */ import_react4.default.createElement(import_react4.default.Fragment, null, /* @__PURE__ */ import_react4.default.createElement(ComparePanel, { job, workspace, jobs, artifacts, gate: gateIdentity, navigation, restoreView, onViewStateChange: (value) => {
  ...
  }, contextFor, setContext: publishContext, askContext, t }), /* @__PURE__ */ import_react4.default.createElement(GateEvidencePanel, { artifacts, interactionObjects: detail?.interactionObjects, contextFor, setContext: publishContext, askContext, navigation, t }));
  else content = stage === "integration" ? /* @__PURE__ */ import_react4.default.createElement(ContractPanel, { artifacts, component, t }) : /* @__PURE__ */ import_react4.default.createElement("section", { className: "hse-section" }, /* @__PURE__ */ import_react4.default.createElement("div", { className: "hse-components" }, /* @__PURE__ */ import_react4.default.createElement("div", { className: "hse-component" }, /* @__PURE__ */ import_react4.default.createElement("span", null, stage, component?.reward_affecting ? " \xB7 reward-affecting" : ""), /* @__PURE__ */ import_react4.default.createElement("b", null, component?.id ?? "\u2014", " \xB7 ", component?.version ?? "\u2014"), /* @__PURE__ */ import_react4.default.createElement("code", null, short(component?.digest)))));
  return /* @__PURE__ */ import_react4.default.createElement("aside", { className: "hse-drawer", "aria-label": job, onClickCapture: () => consumeNavigation?.(navigation), onPointerDown: stopRestoredScroll, onWheel: stopRestoredScroll, onKeyDown: stopRestoredScroll }, /* @__PURE__ */ import_react4.default.createElement("header", { className: "hse-drawer-head" }, /* @__PURE__ */ import_react4.default.createElement("div", null, /* @__PURE__ */ import_react4.default.createElement("h2", null, job), /* @__PURE__ */ import_react4.default.createElement("p", null, historical ? `${t("historicalTarget")} \xB7 ${target.source_kind ?? activeJob?.generationSource?.kind ?? "\u2014"} \xB7 ${target.record_count ?? activeJob?.nTrials ?? 0} ${t("generationRecords")}` : `${activeJob?.candidate?.candidate_id ?? "\u2014"} \xB7 ${activeJob?.candidate?.version ?? "\u2014"}`, " \xB7 ", activeJob?.mode ?? "\u2014", " \xB7 ", activeJob?.progress?.completed ?? 0, "/", activeJob?.progress?.total ?? 0)), /* @__PURE__ */ import_react4.default.createElement("div", { className: "hse-drawer-actions" }, /* @__PURE__ */ import_react4.default.createElement("button", { type: "button", className: "hse-ask", disabled: !jobContext, onClick: () => void askContext(jobContext, t("suggestedQuestion4")) }, t("askAi")), /* @__PURE__ */ import_react4.default.createElement("button", { type: "button", className: "hse-close", onClick: close }, hasHistory ? t("back") : t("backToJobs")))), /* @__PURE__ */ import_react4.default.createElement(JobIdentityHeader, { context: jobContext, summary: activeJob, t }), /* @__PURE__ */ import_react4.default.createElement("div", { className: "hse-workbench" }, /* @__PURE__ */ import_react4.default.createElement("nav", { className: "hse-object-nav", "aria-label": t("mainIdentity") }, JOB_SECTIONS.map((item) => /* @__PURE__ */ import_react4.default.createElement("button", { type: "button", key: item, "aria-current": section === item ? "page" : void 0, onClick: () => openSection(item) }, t(`jobSection_${item}`)))), section === "pipeline" ? /* @__PURE__ */ import_react4.default.createElement(import_react4.default.Fragment, null, /* @__PURE__ */ import_react4.default.createElement("p", { className: "hse-muted" }, t("pipelineHint")), /* @__PURE__ */ import_react4.default.createElement("nav", { className: "hse-stage-nav", "aria-label": t("stageNav") }, STAGES.map((item) => /* @__PURE__ */ import_react4.default.createElement("button", { type: "button", key: item, "data-active": stage === item, "aria-current": stage === item ? "step" : void 0, onClick: () => setStage(item) }, STAGES.indexOf(item) + 1, ". ", historical && item === "candidate" ? t("historicalTarget") : historical && item === "dataset" ? t("generationRecords") : t(item))))) : null, state.status === "loading" ? /* @__PURE__ */ import_react4.default.createElement(HarborSkeleton, { kind: "workbench", rows: 7, label: t("loading") }) : state.status === "error" ? /* @__PURE__ */ import_react4.default.createElement(HarborErrorState, { error: state.error, retry: () => void load(), t }) : /* @__PURE__ */ import_react4.default.createElement(import_react4.default.Fragment, null, state.error ? /* @__PURE__ */ import_react4.default.createElement(HarborErrorState, { error: state.error, title: state.stale ? t("workbenchStale") : void 0, retry: () => void load(), t }) : null, !contextSupported ? /* @__PURE__ */ import_react4.default.createElement("div", { className: "hse-capability" }, t("capabilityUnavailable")) : null, content, /* @__PURE__ */ import_react4.default.createElement("details", { className: "hse-section hse-audit" }, /* @__PURE__ */ import_react4.default.createElement("summary", null, t("audit"), " / ", t("artifacts")), /* @__PURE__ */ import_react4.default.createElement("pre", null, pretty2({ validation: detail.validation, registry: artifacts.registry, context: artifacts.context, doctor: artifacts.doctor }))))));
}
...
function HistoricalLauncher({ snapshot, reload, onCompleted, t }) {
  ...
  return /* @__PURE__ */ import_react4.default.createElement(import_react4.default.Fragment, null, /* @__PURE__ */ import_react4.default.createElement("section", { className: "hse-launch-card", "aria-live": "polite" }, /* @__PURE__ */ import_react4.default.createElement("div", { className: "hse-launch-mark", "aria-hidden": "true" }, "\u2726"), /* @__PURE__ */ import_react4.default.createElement("div", { className: "hse-launch-copy" }, /* @__PURE__ */ import_react4.default.createElement("b", null, active ? t("historicalRunning") : t("historicalLaunch")), /* @__PURE__ */ import_react4.default.createElement("span", null, active ? t("historicalRunningHint") : t("historicalLaunchBody")), /* @__PURE__ */ import_react4.default.createElement("small", null, active ? `${state.operation?.selectedCount ?? "\u2014"} Trials` : t("historicalLaunchHint"))), /* @__PURE__ */ import_react4.default.createElement("button", { type: "button", className: "hse-launch-button", disabled: !workspace || state.status === "previewing", onClick: () => active ? setOpen(true) : void preview() }, /* @__PURE__ */ import_react4.default.createElement("span", { className: "hse-launch-button-full" }, buttonLabel), /* @__PURE__ */ import_react4.default.createElement("span", { className: "hse-launch-button-short" }, buttonShort))), open ? /* @__PURE__ */ import_react4.default.createElement("div", { className: "hse-launch-overlay", role: "presentation", onMouseDown: (event) => event.target === event.currentTarget && close() }, /* @__PURE__ */ import_react4.default.createElement("section", { className: "hse-launch-dialog", role: "dialog", "aria-modal": "true", "aria-labelledby": "hse-historical-title" }, /* @__PURE__ */ import_react4.default.createElement("header", { className: "hse-launch-head" }, /* @__PURE__ */ import_react4.default.createElement("div", null, /* @__PURE__ */ import_react4.default.createElement("span", null, t("historicalLaunchHint")), /* @__PURE__ */ import_react4.default.createElement("h2", { id: "hse-historical-title" }, state.status === "running" ? t("historicalRunning") : t("historicalPreviewTitle")), /* @__PURE__ */ import_react4.default.createElement("p", null, state.status === "running" ? t("historicalRunningHint") : t("historicalPreviewHint"))), /* @__PURE__ */ import_react4.default.createElement("button", { type: "button", className: "hse-dialog-close", "aria-label": t("close"), onClick: close }, "\xD7")), /* @__PURE__ */ import_react4.default.createElement("div", { className: "hse-launch-body" }, state.status === "previewing" ? /* @__PURE__ */ import_react4.default.createElement("div", { className: "hse-empty" }, /* @__PURE__ */ import_react4.default.createElement("div", { className: "hse-spin" }), t("historicalPreparing")) : null, state.status === "starting" ? /* @__PURE__ */ import_react4.default.createElement("div", { className: "hse-empty" }, /* @__PURE__ */ import_react4.default.createElement("div", { className: "hse-spin" }), t("historicalStarting")) : null, state.status === "running" ? /* @__PURE__ */ import_react4.default.createElement("div", { className: "hse-run-state" }, /* @__PURE__ */ import_react4.default.createElement("div", { className: "hse-spin" }), /* @__PURE__ */ import_react4.default.createElement("b", null, t("historicalRunning")), /* @__PURE__ */ import_react4.default.createElement("span", null, state.operation?.selectedCount ?? "\u2014", " Trials \xB7 ", snapshot.workspace.label), /* @__PURE__ */ import_react4.default.createElement("p", null, t("historicalRunningHint"))) : null, state.status === "completed" ? /* @__PURE__ */ import_react4.default.createElement("div", { className: "hse-run-state" }, /* @__PURE__ */ import_react4.default.createElement("b", null, "\u2713 ", t("historicalCompleted"))) : null, state.status === "error" ? /* @__PURE__ */ import_react4.default.createElement(HarborErrorState, { error: { ...state.error, nextStep: historicalErrorHint(state.error.code, t) }, t }) : null, state.status === "ready" && previewValue ? /* @__PURE__ */ import_react4.default.createElement(import_react4.default.Fragment, null, /* @__PURE__ */ import_react4.default.createElement("div", { className: "hse-launch-summary" }, /* @__PURE__ */ import_react4.default.createElement("div", null, /* @__PURE__ */ import_react4.default.createElement("span", null, t("selectedSessions")), /* @__PURE__ */ import_react4.default.createElement("b", null, previewValue.selected.length)), /* @__PURE__ */ import_react4.default.createElement("div", null, /* @__PURE__ */ import_react4.default.createElement("span", null, t("requestEstimate")), /* @__PURE__ */ import_react4.default.createElement("b", null, previewValue.estimatedJudgeRequests)), /* @__PURE__ */ import_react4.default.createElement("div", null, /* @__PURE__ */ import_react4.default.createElement("span", null, t("tokenExpiry")), /* @__PURE__ */ import_react4.default.createElement("b", null, new Date(previewValue.expiresAt).toLocaleTimeString())), /* @__PURE__ */ import_react4.default.createElement("div", null, /* @__PURE__ */ import_react4.default.createElement("span", null, t("workspace")), /* @__PURE__ */ import_react4.default.createElement("b", null, snapshot.workspace.label))), /* @__PURE__ */ import_react4.default.createElement("section", { className: "hse-launch-section" }, /* @__PURE__ */ import_react4.default.createElement("h3", null, t("recentSessions")), /* @__PURE__ */ import_react4.default.createElement("div", { className: "hse-session-list" }, previewValue.selected.map((session) => /* @__PURE__ */ import_react4.default.createElement("article", { key: session.trialId }, /* @__PURE__ */ import_react4.default.createElement("div", null, /* @__PURE__ */ import_react4.default.createElement("b", null, session.title), /* @__PURE__ */ import_react4.default.createElement("span", null, session.lastActivityAt ? new Date(session.lastActivityAt).toLocaleString() : "\u2014")), /* @__PURE__ */ import_react4.default.createElement("p", null, t("turnCounts"), " ", session.turnCount ?? 0, " \xB7 ", t("toolCounts"), " ", session.toolCallCount ?? 0, " \xB7 ", t("feedbackCounts"), " +", session.feedback?.positive ?? 0, " / -", session.feedback?.negative ?? 0), /* @__PURE__ */ import_react4.default.createElement("code", null, (session.modelRoutes ?? []).map((route) => `${route.provider}/${route.model}`).join(" \xB7 ") || session.agentPreset || "\u2014"))))), /* @__PURE__ */ import_react4.default.createElement("section", { className: "hse-launch-section" }, /* @__PURE__ */ import_react4.default.createElement("h3", null, t("historicalBoundaries")), /* @__PURE__ */ import_react4.default.createElement("div", { className: "hse-launch-grid" }, /* @__PURE__ */ import_react4.default.createElement("div", null, /* @__PURE__ */ import_react4.default.createElement("span", null, t("generatorRole")), /* @__PURE__ */ import_react4.default.createElement("b", null, t("generatorRoleValue"))), /* @__PURE__ */ import_react4.default.createElement("div", null, /* @__PURE__ */ import_react4.default.createElement("span", null, t("evaluatorIdentity")), /* @__PURE__ */ import_react4.default.createElement("b", null, evaluator?.id ?? "\u2014", " \xB7 ", evaluator?.version ?? "\u2014")), /* @__PURE__ */ import_react4.default.createElement("div", null, /* @__PURE__ */ import_react4.default.createElement("span", null, t("judgeIdentity")), /* @__PURE__ */ import_react4.default.createElement("b", null, judge?.provider ?? "\u2014", " / ", judge?.model ?? "\u2014")), /* @__PURE__ */ import_react4.default.createElement("div", null, /* @__PURE__ */ import_react4.default.createElement("span", null, t("coupling")), /* @__PURE__ */ import_react4.default.createElement("b", null, previewValue.evaluation?.coupling ?? "\u2014")), /* @__PURE__ */ import_react4.default.createElement("div", null, /* @__PURE__ */ import_react4.default.createElement("span", null, t("evidenceRetention")), /* @__PURE__ */ import_react4.default.createElement("b", null, previewValue.retention?.privateEvidence, " \xB7 ", previewValue.retention?.jobEvidence))), /* @__PURE__ */ import_react4.default.createElement("p", { className: "hse-boundary-note" }, t("historicalBoundaryDetail")))) : null), /* @__PURE__ */ import_react4.default.createElement("footer", { className: "hse-launch-actions" }, state.status === "ready" ? /* @__PURE__ */ import_react4.default.createElement(import_react4.default.Fragment, null, /* @__PURE__ */ import_react4.default.createElement("button", { type: "button", onClick: close }, t("cancel")), /* @__PURE__ */ import_react4.default.createElement("button", { type: "button", className: "hse-confirm", onClick: () => void confirm() }, t("historicalConfirm"))) : null, state.status === "error" ? /* @__PURE__ */ import_react4.default.createElement(import_react4.default.Fragment, null, /* @__PURE__ */ import_react4.default.createElement("button", { type: "button", onClick: close }, t("close")), state.error.code === "SESSION_SELECTION_TOO_EXPENSIVE" ? /* @__PURE__ */ import_react4.default.createElement("button", { type: "button", onClick: () => void preview(30) }, t("recent30Days")) : /* @__PURE__ */ import_react4.default.createElement("button", { type: "button", onClick: () => void preview() }, t("previewAgain"))) : null, state.status === "running" ? /* @__PURE__ */ import_react4.default.createElement("button", { type: "button", onClick: close }, t("close")) : null))) : null);
}
function DashboardView(props) {
  return /* @__PURE__ */ import_react4.default.createElement(DashboardSessionView, { key: String(props.sessionId), ...props });
}
...
function GettingStarted({ jobs, openJob, t }) {
  return /* @__PURE__ */ import_react4.default.createElement("section", { className: "hse-journey", "aria-label": t("journeyTitle") }, /* @__PURE__ */ import_react4.default.createElement("h2", null, t("journeyTitle")), /* @__PURE__ */ import_react4.default.createElement("p", null, t("journeyIntro")), /* @__PURE__ */ import_react4.default.createElement("ol", null, [1, 2, 3].map((step) => /* @__PURE__ */ import_react4.default.createElement("li", { key: step }, t(`journeyStep${step}`)))), jobs?.length ? /* @__PURE__ */ import_react4.default.createElement("button", { type: "button", className: "hse-button", onClick: () => openJob(jobs[0].name) }, t("journeyOpen")) : /* @__PURE__ */ import_react4.default.createElement("p", null, t("journeyEmpty")));
}
function DashboardSessionView({ t, bridge, stop, sessionId, useSession, useInput, inputActions, replaceHarborReference }) {
  ...
  const [offset, setOffset] = (0, import_react4.useState)(0);
  const [attentionFilter, setAttentionFilter] = (0, import_react4.useState)("all");
  const state = useDashboard(true, workspace, offset, sessionId, attentionFilter);
  const [selected, setSelected] = (0, import_react4.useState)();
  const [historyDepth, setHistoryDepth] = (0, import_react4.useState)(0);
  const rootNode = (0, import_react4.useRef)();
  const scrollNode = (0, import_react4.useRef)();
  (0, import_react4.useEffect)(() => {
    scrollNode.current = nearestScrollPort(rootNode.current);
  }, []);
  const navigationHistory = (0, import_react4.useRef)([]);
  const activeWorkbenchView = (0, import_react4.useRef)();
  const handledNavigation = (0, import_react4.useRef)();
  const restoreSequence = (0, import_react4.useRef)(0);
  const pendingDashboardRestore = (0, import_react4.useRef)();
  const [pageSessionId] = (0, import_react4.useState)(pageSessionIdentity);
  ...
  const askContext = (0, import_react4.useCallback)(async (context, prompt = "") => {
  ...
  const resolveLatest = (0, import_react4.useCallback)((token, requestedSessionId) => {
  ...
  const reanalyzeLatest = (0, import_react4.useCallback)(async (context) => {
  ...
  const dockCallbacks = (0, import_react4.useRef)();
  ...
  const completedHistorical = (0, import_react4.useCallback)((operation) => {
    navigationHistory.current = [];
    setHistoryDepth(0);
    activeWorkbenchView.current = void 0;
    pendingDashboardRestore.current = void 0;
  ...
  const closeWorkbench = (0, import_react4.useCallback)(() => {
  ...
  const consumeNavigation = (0, import_react4.useCallback)((navigation) => {
  ...
  return /* @__PURE__ */ import_react4.default.createElement(HarborSessionContext.Provider, { value: sessionId }, /* @__PURE__ */ import_react4.default.createElement("main", { ref: rootNode, className: "hse-root" }, /* @__PURE__ */ import_react4.default.createElement("div", { className: "hse-page hse-layout" }, !ui.workbenchDock?.narrow ? /* @__PURE__ */ import_react4.default.createElement(CopilotDock, { bridge, sessionId, useSession, stop, resolveLatest, reanalyzeLatest, prepareQuestion: askContext, t }) : null, /* @__PURE__ */ import_react4.default.createElement("div", { className: "hse-main-panel" }, selected ? /* @__PURE__ */ import_react4.default.createElement(Workbench, { key: `${selected.workspace}\0${selected.job}`, job: selected.job, workspace: selected.workspace, jobs: snapshot?.jobs ?? [], close: closeWorkbench, navigation: selected.navigation, consumeNavigation, restoreView: selected.restoreView, hasHistory: selected.fromNavigation, scrollContainerRef: scrollNode, onViewStateChange: (value) => {
    activeWorkbenchView.current = value;
  }, sessionId, pageSessionId, bridge, askContext, t }) : /* @__PURE__ */ import_react4.default.createElement(import_react4.default.Fragment, null, historyDepth ? /* @__PURE__ */ import_react4.default.createElement("button", { type: "button", className: "hse-button hse-dashboard-back", onClick: closeWorkbench }, t("back")) : null, snapshot ? /* @__PURE__ */ import_react4.default.createElement(GettingStarted, { jobs: snapshot.jobs, openJob, t }) : null, /* @__PURE__ */ import_react4.default.createElement("section", { className: "hse-health-summary" }, /* @__PURE__ */ import_react4.default.createElement("div", { className: "hse-head" }, /* @__PURE__ */ import_react4.default.createElement("div", null, /* @__PURE__ */ import_react4.default.createElement("small", null, "Harbor \xB7 ", t("eyebrow")), /* @__PURE__ */ import_react4.default.createElement("h1", null, t("health"), ": ", t((snapshot?.overview?.attention?.blocked ?? 0) > 0 ? "health_blocked" : ["blocked", "stalled", "infrastructure", "invalid", "regressed", "gate", "fresh-baseline"].some((key) => (snapshot?.overview?.attention?.[key] ?? 0) > 0) ? "healthRisk" : "healthy")), /* @__PURE__ */ import_react4.default.createElement("p", null, t("attentionCountHint"))), /* @__PURE__ */ import_react4.default.createElement("button", { type: "button", className: "hse-button", onClick: () => void state.load() }, t("refresh"))), /* @__PURE__ */ import_react4.default.createElement("div", { className: "hse-health-filters", "aria-label": t("attention") }, ATTENTION_FILTERS.map((filter) => /* @__PURE__ */ import_react4.default.createElement("button", { type: "button", key: filter, "aria-pressed": attentionFilter === filter, onClick: () => {
    setAttentionFilter(filter);
    setOffset(0);
  } }, /* @__PURE__ */ import_react4.default.createElement("span", null, t(`health_${filter}`)), /* @__PURE__ */ import_react4.default.createElement("b", null, snapshot?.overview?.attention?.[filter] ?? "\u2014"))))), snapshot?.workspace ? /* @__PURE__ */ import_react4.default.createElement(HistoricalLauncher, { snapshot, reload: state.load, onCompleted: completedHistorical, t }) : null, state.stale ? /* @__PURE__ */ import_react4.default.createElement("div", { className: "hse-capability" }, t("dashboardStale")) : null, /* @__PURE__ */ import_react4.default.createElement("div", { className: "hse-head" }, /* @__PURE__ */ import_react4.default.createElement("div", null, /* @__PURE__ */ import_react4.default.createElement("h2", null, t("attention"), " \xB7 ", t(`health_${attentionFilter}`)), /* @__PURE__ */ import_react4.default.createElement("p", null, t("jobsHint"))), snapshot?.workspaces?.length ? /* @__PURE__ */ import_react4.default.createElement("select", { className: "hse-select", "aria-label": t("workspaceSelect"), value: snapshot.workspace?.id ?? "", onChange: switchWorkspace }, snapshot.workspaces.map((item) => /* @__PURE__ */ import_react4.default.createElement("option", { value: item.id, key: item.id }, item.label, " \xB7 ", item.root))) : null), snapshot?.workspace ? /* @__PURE__ */ import_react4.default.createElement("div", { className: "hse-hook-state" }, /* @__PURE__ */ import_react4.default.createElement("b", null, t("workspace"), ": ", snapshot.workspace.label), /* @__PURE__ */ import_react4.default.createElement("br", null), snapshot.config.projectRoot, " \xB7 ", snapshot.config.jobsDir) : null, state.status === "loading" ? /* @__PURE__ */ import_react4.default.createElement(HarborSkeleton, { kind: "dashboard", rows: 7, label: t("loading") }) : state.status === "error" && !snapshot ? /* @__PURE__ */ import_react4.default.createElement(HarborErrorState, { error: state.errorDetails ?? state.error, retry: () => void state.load(), t }) : !snapshot?.jobs?.length ? /* @__PURE__ */ import_react4.default.createElement("div", { className: "hse-empty" }, t(attentionFilter === "all" ? "empty" : "noFilteredJobs"), attentionFilter !== "all" ? /* @__PURE__ */ import_react4.default.createElement("button", { type: "button", className: "hse-button", onClick: () => {
    setAttentionFilter("all");
    setOffset(0);
  } }, t("clearFilters")) : null) : /* @__PURE__ */ import_react4.default.createElement(import_react4.default.Fragment, null, /* @__PURE__ */ import_react4.default.createElement("div", { className: "hse-list" }, snapshot.jobs.map((job) => /* @__PURE__ */ import_react4.default.createElement(JobCard, { job, t, open: openJob, ask: askJob, key: job.name }))), /* @__PURE__ */ import_react4.default.createElement("div", { className: "hse-pager" }, /* @__PURE__ */ import_react4.default.createElement("span", null, pagination.total ? `${offset + 1}\u2013${Math.min(offset + (snapshot.jobs?.length ?? 0), pagination.total)} / ${pagination.total}` : "0 / 0"), /* @__PURE__ */ import_react4.default.createElement("button", { disabled: !offset, onClick: () => setOffset(Math.max(0, offset - (pagination.limit ?? 20))) }, t("previous")), /* @__PURE__ */ import_react4.default.createElement("button", { disabled: !pagination.hasMore, onClick: () => setOffset(offset + (pagination.limit ?? 20)) }, t("next")))))))));
}
function VersionPanel({ t }) {
  ...
  return /* @__PURE__ */ import_react4.default.createElement("section", { className: "hse-version", "data-status": status, "aria-live": "polite" }, /* @__PURE__ */ import_react4.default.createElement("header", { className: "hse-version-head" }, /* @__PURE__ */ import_react4.default.createElement("h3", null, "\u{1F433} ", t("pluginVersion")), /* @__PURE__ */ import_react4.default.createElement("span", { className: "hse-version-badge" }, statusLabel)), value ? /* @__PURE__ */ import_react4.default.createElement("div", { className: "hse-version-grid" }, /* @__PURE__ */ import_react4.default.createElement("div", { className: "hse-version-card" }, /* @__PURE__ */ import_react4.default.createElement("span", null, t("currentVersion")), /* @__PURE__ */ import_react4.default.createElement("b", null, value.currentVersion)), /* @__PURE__ */ import_react4.default.createElement("div", { className: "hse-version-card" }, /* @__PURE__ */ import_react4.default.createElement("span", null, t("latestVersion")), /* @__PURE__ */ import_react4.default.createElement("b", null, value.latestVersion ?? "\u2014"))) : null, status === "update-available" ? /* @__PURE__ */ import_react4.default.createElement(import_react4.default.Fragment, null, /* @__PURE__ */ import_react4.default.createElement("p", { className: "hse-version-copy" }, t("updateHint")), /* @__PURE__ */ import_react4.default.createElement("code", { className: "hse-update-command" }, value.command)) : null, status === "unavailable" ? /* @__PURE__ */ import_react4.default.createElement("p", { className: "hse-version-copy" }, t("offlineUpdateHint")) : null, value?.stale ? /* @__PURE__ */ import_react4.default.createElement("p", { className: "hse-version-copy" }, t("staleVersion")) : null, /* @__PURE__ */ import_react4.default.createElement("div", { className: "hse-version-actions" }, value?.command ? /* @__PURE__ */ import_react4.default.createElement("button", { className: "hse-primary", type: "button", onClick: () => void copy2() }, copied ? t("updateCommandCopied") : t("copyUpdateCommand")) : null, value?.releaseUrl ? /* @__PURE__ */ import_react4.default.createElement("a", { href: value.releaseUrl, target: "_blank", rel: "noreferrer" }, t("viewRelease")) : null, status !== "loading" ? /* @__PURE__ */ import_react4.default.createElement("button", { type: "button", onClick: () => void state.load(true) }, t("checkAgain")) : null, value?.checkedAt ? /* @__PURE__ */ import_react4.default.createElement("small", null, t("checkedAt"), ": ", new Date(value.checkedAt).toLocaleString()) : null));
}
function DoctorView({ t }) {
  const state = useDashboard(false);
  const [projectRoot, setProjectRoot] = (0, import_react4.useState)("");
  const [mutation, setMutation] = (0, import_react4.useState)({ status: "idle" });
  (0, import_react4.useEffect)(() => {
  ...
  return /* @__PURE__ */ import_react4.default.createElement("main", { className: "hse-root" }, /* @__PURE__ */ import_react4.default.createElement("div", { className: "hse-settings" }, /* @__PURE__ */ import_react4.default.createElement("h2", null, t("setupDoctor")), /* @__PURE__ */ import_react4.default.createElement("p", null, t("setupHint")), state.errorDetails ? /* @__PURE__ */ import_react4.default.createElement(HarborErrorState, { error: state.errorDetails, title: state.stale ? t("dashboardStale") : void 0, retry: () => void state.load(), t }) : null, /* @__PURE__ */ import_react4.default.createElement(VersionPanel, { t }), /* @__PURE__ */ import_react4.default.createElement("div", { className: "hse-root-switch" }, /* @__PURE__ */ import_react4.default.createElement("label", { htmlFor: "hse-project-root" }, t("projectRoot")), /* @__PURE__ */ import_react4.default.createElement("input", { id: "hse-project-root", value: projectRoot, onChange: (event) => setProjectRoot(event.target.value), spellCheck: false }), /* @__PURE__ */ import_react4.default.createElement("button", { type: "button", disabled: mutation.status === "saving" || !projectRoot, onClick: () => void switchRoot() }, mutation.status === "saving" ? t("switchingProjectRoot") : t("switchProjectRoot")), /* @__PURE__ */ import_react4.default.createElement("small", null, mutation.status === "saved" ? t("projectRootUpdated") : t("projectRootHint")), /* @__PURE__ */ import_react4.default.createElement("small", null, rootSource), mutation.status === "error" ? /* @__PURE__ */ import_react4.default.createElement(HarborErrorState, { error: mutation.error, retry: () => void switchRoot(), t }) : null), /* @__PURE__ */ import_react4.default.createElement("div", { className: "hse-checks" }, Object.entries(state.value?.checks ?? {}).map(([key, check]) => /* @__PURE__ */ import_react4.default.createElement("div", { className: "hse-check", key }, /* @__PURE__ */ import_react4.default.createElement("b", { className: check.status === "ok" ? "hse-valid" : "hse-invalid" }, key, " \xB7 ", check.status), /* @__PURE__ */ import_react4.default.createElement("small", null, check.detail)))), /* @__PURE__ */ import_react4.default.createElement("h3", null, t("credentialPolicy")), /* @__PURE__ */ import_react4.default.createElement("div", { className: "hse-checks" }, credentialTiers.map(([label, status, hint, active]) => /* @__PURE__ */ import_react4.default.createElement("div", { className: "hse-check", key: label }, /* @__PURE__ */ import_react4.default.createElement("b", { className: active ? "hse-valid" : "hse-invalid" }, label, " \xB7 ", status), /* @__PURE__ */ import_react4.default.createElement("small", null, hint))))));
}
...
function HarborToolView({ block, toolName, bridge, sessionId, t }) {
  ...
  return /* @__PURE__ */ import_react4.default.createElement("section", { className: "hse-tool" }, /* @__PURE__ */ import_react4.default.createElement("button", { type: "button", onClick: () => setOpen(!open) }, /* @__PURE__ */ import_react4.default.createElement("strong", null, "\u{1F433} ", toolName), /* @__PURE__ */ import_react4.default.createElement("small", null, running ? "running" : block.isError ? "error" : "\u2713")), open ? /* @__PURE__ */ import_react4.default.createElement("pre", null, value ? pretty2(value) : blockText(block) || "Running\u2026") : null, uiAction ? /* @__PURE__ */ import_react4.default.createElement("button", { type: "button", className: "hse-tool-action", onClick: () => bridge.navigate(sessionId, uiAction, { force: true }) }, t("viewInHarbor")) : null);
}
