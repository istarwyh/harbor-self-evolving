...
var dictionaries = {
  zh: {
    ...
    currentVersion: "\u5F53\u524D\u7248\u672C",
    latestVersion: "\u6700\u65B0\u7248\u672C",
    updateHint: "\u70B9\u51FB\u4E00\u952E\u66F4\u65B0\u5373\u53EF\u5347\u7EA7 Plugin\u3001Skill \u548C Harbor Adapter\uFF1B\u5B8C\u6210\u540E\u9700\u8981\u91CD\u542F YourBuddy\u3002",
    offlineUpdateHint: "\u8FD9\u4E0D\u4F1A\u5F71\u54CD Harbor \u7684\u4EFB\u4F55\u529F\u80FD\u3002\u8BF7\u68C0\u67E5\u7F51\u7EDC\u540E\u91CD\u8BD5\uFF0C\u6216\u5728\u7EC8\u7AEF\u8FD0\u884C\u5E26 @latest \u7684\u5B89\u88C5\u547D\u4EE4\u3002",
    updateNow: "\u4E00\u952E\u66F4\u65B0\u5230",
    updatingNow: "\u6B63\u5728\u66F4\u65B0\u2026",
    updateInstalled: "\u66F4\u65B0\u5DF2\u5B89\u88C5\uFF0C\u8BF7\u91CD\u542F YourBuddy \u540E\u751F\u6548\u3002",
    updateFailed: "\u66F4\u65B0\u5931\u8D25",
  ...
  en: {
    ...
    updateHint: "Use one-click update to upgrade the Plugin, Skill, and Harbor Adapter. Restart YourBuddy when it finishes.",
    ...
    updateNow: "Update now to",
    updatingNow: "Updating\u2026",
    updateInstalled: "Update installed. Restart YourBuddy to activate it.",
...
function VersionPanel({ t }) {
  ...
  const [copied, setCopied] = (0, import_react5.useState)(false);
  const [installation, setInstallation] = (0, import_react5.useState)({ status: "idle" });
