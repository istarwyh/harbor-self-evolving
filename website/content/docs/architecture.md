...
![Harbor Self-Evolving architecture](https://istarwyh.github.io/harbor-self-evolving/images/diagrams/system-architecture.svg "Current 0.9.6 contract plus labeled known issue")
...
0.9.6 defaults to **Host**. Docker is explicit opt-in. Execution environment identity enters Context so Host and Docker results are not silently treated as comparable.
