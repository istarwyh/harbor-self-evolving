...
| 导入部署后的聚合业务指标 | [外部业务观察](business-observations.md) | [架构](architecture.md)、[安全边界](security.md) |
...
| [外部业务观察](business-observations.md) | 业务与评测工程师 | reviewed aggregate 导入、身份/窗口/指标、趋势、敏感数据和因果边界 |
...
- [npm Plugin](../packages/dsh-plugin/README.md)：安装器、21 个工具、Web Workbench 和 Host 集成细节。
