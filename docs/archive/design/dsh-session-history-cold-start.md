...
> **归档说明：**这是 2026-08-30 的设计与实施过程快照，已被当前的 [架构说明](../../architecture.md)、[接入指南](../../integration.md) 和正式发布记录取代。文中的“当前”“实施中”与默认 10 条会话描述仅代表当时方案，不是现行 Web 行为；当前 Web 默认最多 3 条，Agent/Skill 工具最多可请求 10 条。
